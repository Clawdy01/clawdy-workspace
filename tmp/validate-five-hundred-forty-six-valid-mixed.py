...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:531]
if len(valid_cases) != 531:
    raise SystemExit(f'kon geen vijfhonderdzesenveertig geldige casenamen vinden, kreeg {valid_cases}')
