...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:527]
if len(valid_cases) != 527:
    raise SystemExit(f'kon geen vijfhonderdtweeënveertig geldige casenamen vinden, kreeg {valid_cases}')
