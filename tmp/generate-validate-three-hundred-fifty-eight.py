...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-fifty-eight'),
    ('tweehonderdnegenentwintig', 'driehonderdachtenvijftig'),
    ('[:227]', '[:354]'),
    ('!= 227', '!= 354'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-fifty-eight-{kind}.py'
    text = src.read_text()
