...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-twenty-six'),
    ('driehonderdnegenenzestig', 'vijfhonderdzesentwintig'),
    ('all_cases[:364]', 'all_cases[:511]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:511]'),
    ('!= 364', '!= 511'),
