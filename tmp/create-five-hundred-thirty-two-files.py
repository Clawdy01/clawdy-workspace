...
repls = [
    ('three-hundred-seventy-four', 'five-hundred-thirty-two'),
    ('driehonderdvierenzeventig', 'vijfhonderdtweeëndertig'),
    ('all_cases[:369]', 'all_cases[:517]'),
    ('{UNKNOWN, TYPO}][:369]', '{UNKNOWN, TYPO}][:517]'),
    ('!= 369', '!= 517'),
