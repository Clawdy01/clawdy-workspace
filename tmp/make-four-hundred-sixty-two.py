...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-sixty-two'),
    ('driehonderdvierentachtig', 'vierhonderdtweeënzestig'),
    ('all_cases[:379]', 'all_cases[:447]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:447]'),
    ('!= 379', '!= 447'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-sixty-two')).write_text(text)
