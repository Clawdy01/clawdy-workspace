...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-seventy-one'),
    ('driehonderdvierentachtig', 'vijfhonderdeenenzeventig'),
    ('all_cases[:379]', 'all_cases[:556]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:556]'),
    ('!= 379', '!= 556'),
