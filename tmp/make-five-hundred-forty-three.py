...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-forty-three'),
    ('driehonderdvierentachtig', 'vijfhonderddrieënveertig'),
    ('all_cases[:379]', 'all_cases[:528]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:528]'),
    ('!= 379', '!= 528'),
