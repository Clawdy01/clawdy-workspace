...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-eighty-eight'),
    ('driehonderdvierentachtig', 'vijfhonderdachtentachtig'),
    ('all_cases[:379]', 'all_cases[:573]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:573]'),
    ('!= 379', '!= 573'),
