...
repls = [
    ('three-hundred-sixty-one', 'five-hundred-twenty-five'),
    ('driehonderdeenenzestig', 'vijfhonderdvijfentwintig'),
    ('all_cases[:356]', 'all_cases[:510]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:510]'),
    ('!= 356', '!= 510'),
