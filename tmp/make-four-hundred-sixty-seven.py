...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-sixty-seven'),
    ('driehonderdvierentachtig', 'vierhonderdzevenenzestig'),
    ('all_cases[:379]', 'all_cases[:452]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:452]'),
    ('!= 379', '!= 452'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-sixty-seven')).write_text(text)
