...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-twenty-seven'),
    ('driehonderdnegenenzestig', 'vijfhonderdzevenentwintig'),
    ('all_cases[:364]', 'all_cases[:512]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:512]'),
    ('!= 364', '!= 512'),
