...
repls = [
    ('four-hundred-sixty-three', 'four-hundred-sixty-six'),
    ('vierhonderddrieënzestig', 'vierhonderdzesenzestig'),
    ('[:448]', '[:451]'),
    ('!= 448', '!= 451'),
    ('kreeg 448', 'kreeg 451'),
]
for name in files:
    ...
    (root / name.replace('four-hundred-sixty-three', 'four-hundred-sixty-six')).write_text(text)
print('created')
