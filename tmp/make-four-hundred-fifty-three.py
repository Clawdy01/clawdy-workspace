...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-fifty-three'),
    ('driehonderdvierentachtig', 'vierhonderddrieënvijftig'),
    ('all_cases[:379]', 'all_cases[:438]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:438]'),
    ('!= 379', '!= 438'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-fifty-three')).write_text(text)
