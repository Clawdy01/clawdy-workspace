...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-forty-nine'),
    ('driehonderdvierentachtig', 'vijfhonderdnegenenveertig'),
    ('all_cases[:379]', 'all_cases[:534]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:534]'),
    ('!= 379', '!= 534'),
