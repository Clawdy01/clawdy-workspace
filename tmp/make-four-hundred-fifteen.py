...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-fifteen'),
    ('driehonderdvierentachtig', 'vierhonderdvijftien'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-fifteen')).write_text(text)
