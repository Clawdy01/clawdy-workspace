...
repls = [
    ('three-hundred-sixty-one', 'five-hundred-thirty-five'),
    ('driehonderdeenenzestig', 'vijfhonderdvijfendertig'),
    ('all_cases[:356]', 'all_cases[:520]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:520]'),
    ('!= 356', '!= 520'),
