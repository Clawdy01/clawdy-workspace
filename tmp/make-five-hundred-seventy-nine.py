...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-seventy-nine'),
    ('driehonderdvierentachtig', 'vijfhonderdnegenenzeventig'),
    ('all_cases[:379]', 'all_cases[:564]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:564]'),
    ('!= 379', '!= 564'),
