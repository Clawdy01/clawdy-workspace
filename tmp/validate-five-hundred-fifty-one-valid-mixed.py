...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:536]
if len(valid_cases) != 536:
    raise SystemExit(f'kon geen vijfhonderdeenenvijftig geldige casenamen vinden, kreeg {valid_cases}')
