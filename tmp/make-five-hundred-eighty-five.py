...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-eighty-five'),
    ('driehonderdvierentachtig', 'vijfhonderdvijfentachtig'),
    ('all_cases[:379]', 'all_cases[:570]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:570]'),
    ('!= 379', '!= 570'),
