...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-fifty-two'),
    ('driehonderdvierentachtig', 'vijfhonderdtweeënvijftig'),
    ('all_cases[:379]', 'all_cases[:537]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:537]'),
    ('!= 379', '!= 537'),
