...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-seventeen'),
    ('driehonderdvierentachtig', 'zeshonderdzeventien'),
    ('all_cases[:379]', 'all_cases[:602]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:602]'),
    ('!= 379', '!= 602'),
