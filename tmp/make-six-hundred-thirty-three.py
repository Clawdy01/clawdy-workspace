...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-thirty-three'),
    ('driehonderdvierentachtig', 'zeshonderddrieëndertig'),
    ('all_cases[:379]', 'all_cases[:618]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:618]'),
    ('!= 379', '!= 618'),
