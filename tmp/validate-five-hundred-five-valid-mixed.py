...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:490]
if len(valid_cases) != 490:
    raise SystemExit(f'kon geen vijfhonderdvijf geldige casenamen vinden, kreeg {valid_cases}')
