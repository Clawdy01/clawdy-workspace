...
repls = [
    ('four-hundred-thirty-four', 'four-hundred-forty-five'),
    ('vierhonderdvierendertig', 'vierhonderdvijfenveertig'),
    ('[:424]', '[:424]'),
    ('!= 422', '!= 430'),
    ('kreeg 422', 'kreeg 430'),
    (' 419)', ' 420)'),
    (', 413, 414, 415, 416, 417, 418]', ', 413, 414, 415, 416, 417, 418, 419, 420, 421, 422, 423, 424, 425, 426, 427, 428, 429]'),
]
for name in files:
    text = (root / name).read_text()
    for old, new in repls:
        text = text.replace(old, new)
    (root / name.replace('four-hundred-thirty-four', 'four-hundred-forty-five')).write_text(text)
