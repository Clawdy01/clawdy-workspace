...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-thirty-five'),
    ('driehonderdvierentachtig', 'vierhonderdvijfendertig'),
    ('all_cases[:379]', 'all_cases[:420]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:420]'),
    ('!= 379', '!= 420'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-thirty-five')).write_text(text)
