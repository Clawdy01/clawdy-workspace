...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-sixty-one'),
    ('driehonderdvierentachtig', 'vierhonderdeenenzestig'),
    ('all_cases[:379]', 'all_cases[:446]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:446]'),
    ('!= 379', '!= 446'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-sixty-one')).write_text(text)
