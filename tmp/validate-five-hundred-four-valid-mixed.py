...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:489]
if len(valid_cases) != 489:
    raise SystemExit(f'kon geen vijfhonderdvier geldige casenamen vinden, kreeg {valid_cases}')
