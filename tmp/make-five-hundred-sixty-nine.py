...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-sixty-nine'),
    ('driehonderdvierentachtig', 'vijfhonderdnegenenzestig'),
    ('all_cases[:379]', 'all_cases[:554]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:554]'),
    ('!= 379', '!= 554'),
