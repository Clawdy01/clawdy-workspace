...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:526]
if len(valid_cases) != 526:
    raise SystemExit(f'kon geen vijfhonderdeenenveertig geldige casenamen vinden, kreeg {valid_cases}')
