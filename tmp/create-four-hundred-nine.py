...
repls = [
    ('three-hundred-sixty-nine', 'four-hundred-nine'),
    ('driehonderdnegenenzestig', 'vierhonderdnegen'),
...
for name in (
    ...
    src = root / 'tmp' / name
    dst = root / 'tmp' / name.replace('three-hundred-sixty-nine', 'four-hundred-nine')
    text = src.read_text()
