...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-thirteen'),
    ('driehonderdvierentachtig', 'vierhonderddertien'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-thirteen')).write_text(text)
