...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-twenty-eight'),
    ('tweehonderdnegenentwintig', 'driehonderdachtentwintig'),
    ('[:227]', '[:324]'),
    ('!= 227', '!= 324'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-twenty-eight-{kind}.py'
    text = src.read_text()
