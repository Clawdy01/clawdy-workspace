...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:513]
if len(valid_cases) != 513:
    raise SystemExit(f'kon geen vijfhonderdachtentwintig geldige casenamen vinden, kreeg {valid_cases}')
