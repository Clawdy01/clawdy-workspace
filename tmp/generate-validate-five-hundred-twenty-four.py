...
repls = [
    ('three-hundred-sixty-one', 'five-hundred-twenty-four'),
    ('driehonderdeenenzestig', 'vijfhonderdvierentwintig'),
    ('all_cases[:356]', 'all_cases[:509]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:509]'),
    ('!= 356', '!= 509'),
