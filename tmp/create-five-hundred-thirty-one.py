...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-thirty-one'),
    ('driehonderdnegenenzestig', 'vijfhonderdeenendertig'),
    ('all_cases[:364]', 'all_cases[:516]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:516]'),
    ('!= 364', '!= 516'),
