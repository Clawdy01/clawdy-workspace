...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-twenty-three'),
    ('tweehonderdnegenentwintig', 'driehonderddrieentwintig'),
    ('[:227]', '[:319]'),
    ('!= 227', '!= 319'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-twenty-three-{kind}.py'
    text = src.read_text()
