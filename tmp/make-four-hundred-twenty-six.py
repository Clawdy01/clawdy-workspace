...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-twenty-six'),
    ('driehonderdvierentachtig', 'vierhonderdzesentwintig'),
    ('all_cases[:379]', 'all_cases[:411]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:411]'),
    ('!= 379', '!= 411'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-twenty-six')).write_text(text)
