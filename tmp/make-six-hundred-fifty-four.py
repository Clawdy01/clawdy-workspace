...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-fifty-four'),
    ('driehonderdvierentachtig', 'zeshonderdvierenvijftig'),
    ('all_cases[:379]', 'all_cases[:639]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:639]'),
    ('!= 379', '!= 639'),
