...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:543]
if len(valid_cases) != 543:
    raise SystemExit(f'kon geen vijfhonderdachtenvijftig geldige casenamen vinden, kreeg {valid_cases}')
