...
repls = [
    ('four-hundred-sixty-three', 'four-hundred-sixty-seven'),
    ('vierhonderddrieënzestig', 'vierhonderdzevenenzestig'),
    ('[:448]', '[:452]'),
    ('!= 448', '!= 452'),
    ('kreeg 448', 'kreeg 452'),
]
for name in files:
    ...
    (root / name.replace('four-hundred-sixty-three', 'four-hundred-sixty-seven')).write_text(text)
print('created')
