...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-fifty-nine'),
    ('driehonderdvierentachtig', 'vierhonderdnegenenvijftig'),
    ('all_cases[:379]', 'all_cases[:444]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:444]'),
    ('!= 379', '!= 444'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-fifty-nine')).write_text(text)
