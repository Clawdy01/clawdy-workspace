...
repls = [
    ('three-hundred-sixty-one', 'five-hundred-thirty-eight'),
    ('driehonderdeenenzestig', 'vijfhonderdachtendertig'),
    ('all_cases[:356]', 'all_cases[:523]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:523]'),
    ('!= 356', '!= 523'),
