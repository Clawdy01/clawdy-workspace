...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-twenty-seven'),
    ('driehonderdvierentachtig', 'vierhonderdzevenentwintig'),
    ('all_cases[:379]', 'all_cases[:412]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:412]'),
    ('!= 379', '!= 412'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-twenty-seven')).write_text(text)
