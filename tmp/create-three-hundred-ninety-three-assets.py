...
repls = [
    ('three-hundred-eighty-seven', 'three-hundred-ninety-three'),
    ('driehonderdzevenentachtig', 'driehonderddrieënnegentig'),
    ('all_cases[:382]', 'all_cases[:388]'),
    ('{UNKNOWN, TYPO}][:382]', '{UNKNOWN, TYPO}][:388]'),
    ('!= 382', '!= 388'),
...
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'three-hundred-ninety-three')).write_text(text)
