...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-thirty-two'),
    ('driehonderdvierentachtig', 'vierhonderdtweeendertig'),
    ('all_cases[:379]', 'all_cases[:417]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:417]'),
    ('!= 379', '!= 417'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-thirty-two')).write_text(text)
