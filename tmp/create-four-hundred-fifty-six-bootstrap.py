...
repls = [
    ('four-hundred-fifty-five', 'four-hundred-fifty-six'),
    ('vierhonderdvijfenvijftig', 'vierhonderdzesenvijftig'),
    ('all_cases[:440]', 'all_cases[:441]'),
    ('{UNKNOWN, TYPO}][:440]', '{UNKNOWN, TYPO}][:441]'),
    ('!= 440', '!= 441'),
    ('kreeg 440', 'kreeg 441'),
    (', 430, 431, 432, 433, 434, 435, 436, 437, 438, 439]', ', 430, 431, 432, 433, 434, 435, 436, 437, 438, 439, 440]'),
]
for src_name in [
    ...
    src = root / src_name
    dst = root / src_name.replace('four-hundred-fifty-five', 'four-hundred-fifty-six')
    text = src.read_text()
