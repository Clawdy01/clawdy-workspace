...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-fourteen'),
    ('driehonderdnegenenzestig', 'vijfhonderdveertien'),
    ('all_cases[:364]', 'all_cases[:499]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:499]'),
    ('!= 364', '!= 499'),
