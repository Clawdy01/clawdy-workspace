...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:541]
if len(valid_cases) != 541:
    raise SystemExit(f'kon geen vijfhonderdzesenvijftig geldige casenamen vinden, kreeg {valid_cases}')
