...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:542]
if len(valid_cases) != 542:
    raise SystemExit(f'kon geen vijfhonderdzevenenvijftig geldige casenamen vinden, kreeg {valid_cases}')
