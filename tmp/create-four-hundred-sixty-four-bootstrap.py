...
repls = [
    ('four-hundred-fifty-eight', 'four-hundred-sixty-four'),
    ('vierhonderdachtenvijftig', 'vierhonderdvierenzestig'),
    ('all_cases[:443]', 'all_cases[:449]'),
    ('{UNKNOWN, TYPO}][:443]', '{UNKNOWN, TYPO}][:449]'),
    ('!= 443', '!= 449'),
    ('kreeg 443', 'kreeg 449'),
...
for src_name in [
    ...
    src = root / src_name
    dst = root / src_name.replace('four-hundred-fifty-eight', 'four-hundred-sixty-four')
    text = src.read_text()
