...
repls = [
    ('three-hundred-sixty-one', 'four-hundred-seventeen'),
    ('driehonderdeenenzestig', 'vierhonderdzeventien'),
    ('all_cases[:356]', 'all_cases[:402]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:402]'),
    ('!= 356', '!= 402'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-four-hundred-seventeen-{kind}.py'
    text = src.read_text()
