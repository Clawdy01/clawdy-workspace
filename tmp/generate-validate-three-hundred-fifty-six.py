...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-fifty-six'),
    ('tweehonderdnegenentwintig', 'driehonderdzesenvijftig'),
    ('[:227]', '[:352]'),
    ('!= 227', '!= 352'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-fifty-six-{kind}.py'
    text = src.read_text()
