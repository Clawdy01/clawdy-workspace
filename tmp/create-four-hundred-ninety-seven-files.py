...
repls = [
    ('three-hundred-seventy-four', 'four-hundred-ninety-seven'),
    ('driehonderdvierenzeventig', 'vierhonderdzevenennegentig'),
    ('all_cases[:369]', 'all_cases[:482]'),
    ('{UNKNOWN, TYPO}][:369]', '{UNKNOWN, TYPO}][:482]'),
    ('!= 369', '!= 482'),
    ('366, 367, 368]', '366, 367, 368, 369, 370, 371, 372, 373, 374, 375, 376, 377, 378, 379, 380, 381, 382, 383, 384, 385, 386, 387, 388, 389, 390, 391, 392, 393, 394, 395, 396, 397, 398, 399, 400, 401, 402, 403, 404, 405, 406, 407, 408, 409, 410]'),
]
