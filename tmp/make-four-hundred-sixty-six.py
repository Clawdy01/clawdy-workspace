...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-sixty-six'),
    ('driehonderdvierentachtig', 'vierhonderdzesenzestig'),
    ('all_cases[:379]', 'all_cases[:451]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:451]'),
    ('!= 379', '!= 451'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-sixty-six')).write_text(text)
