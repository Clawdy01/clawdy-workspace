...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-thirty-four'),
    ('driehonderdvierentachtig', 'vijfhonderdvierendertig'),
    ('all_cases[:379]', 'all_cases[:519]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:519]'),
    ('!= 379', '!= 519'),
