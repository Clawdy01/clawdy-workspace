...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-thirty-seven'),
    ('driehonderdvierentachtig', 'zeshonderdzevenendertig'),
    ('all_cases[:379]', 'all_cases[:622]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:622]'),
    ('!= 379', '!= 622'),
