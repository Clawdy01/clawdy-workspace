...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-ninety-three'),
    ('driehonderdvierentachtig', 'vijfhonderddrieënnegentig'),
    ('all_cases[:379]', 'all_cases[:578]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:578]'),
    ('!= 379', '!= 578'),
