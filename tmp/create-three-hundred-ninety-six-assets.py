...
repls = [
    ('three-hundred-eighty-seven', 'three-hundred-ninety-six'),
    ('driehonderdzevenentachtig', 'driehonderdzesennegentig'),
    ('all_cases[:382]', 'all_cases[:391]'),
    ('{UNKNOWN, TYPO}][:382]', '{UNKNOWN, TYPO}][:391]'),
    ('!= 382', '!= 391'),
...
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'three-hundred-ninety-six')).write_text(text)
