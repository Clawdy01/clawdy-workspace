...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-forty-six'),
    ('driehonderdvierentachtig', 'zeshonderdzesenveertig'),
    ('all_cases[:379]', 'all_cases[:631]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:631]'),
    ('!= 379', '!= 631'),
