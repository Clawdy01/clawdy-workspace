...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:499]
if len(valid_cases) != 499:
    raise SystemExit(f'kon geen vijfhonderdveertien geldige casenamen vinden, kreeg {valid_cases}')
