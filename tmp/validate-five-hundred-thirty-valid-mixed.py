...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:515]
if len(valid_cases) != 515:
    raise SystemExit(f'kon geen vijfhonderddertig geldige casenamen vinden, kreeg {valid_cases}')
