...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-fifty-eight'),
    ('driehonderdvierentachtig', 'vierhonderdachtenvijftig'),
    ('all_cases[:379]', 'all_cases[:443]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:443]'),
    ('!= 379', '!= 443'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-fifty-eight')).write_text(text)
