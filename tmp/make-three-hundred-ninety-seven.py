...
repls = [
    ('three-hundred-eighty-four', 'three-hundred-ninety-seven'),
    ('driehonderdvierentachtig', 'driehonderdzevenennegentig'),
    ('all_cases[:379]', 'all_cases[:392]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:392]'),
    ('!= 379', '!= 392'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'three-hundred-ninety-seven')).write_text(text)
