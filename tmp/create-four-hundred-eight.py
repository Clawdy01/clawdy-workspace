...
repls = [
    ('three-hundred-sixty-nine', 'four-hundred-eight'),
    ('driehonderdnegenenzestig', 'vierhonderdacht'),
...
for name in (
    ...
    src = root / 'tmp' / name
    dst = root / 'tmp' / name.replace('three-hundred-sixty-nine', 'four-hundred-eight')
    text = src.read_text()
