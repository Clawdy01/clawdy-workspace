...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:552]
if len(valid_cases) != 552:
    raise SystemExit(f'kon geen vijfhonderdzevenenzestig geldige casenamen vinden, kreeg {valid_cases}')
