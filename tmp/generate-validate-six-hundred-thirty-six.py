...
repls = [
    ('three-hundred-sixty-one', 'six-hundred-thirty-six'),
    ('driehonderdeenenzestig', 'zeshonderdzesendertig'),
    ('all_cases[:356]', 'all_cases[:621]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:621]'),
    ('!= 356', '!= 621'),
