...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:539]
if len(valid_cases) != 539:
    raise SystemExit(f'kon geen vijfhonderdvierenvijftig geldige casenamen vinden, kreeg {valid_cases}')
