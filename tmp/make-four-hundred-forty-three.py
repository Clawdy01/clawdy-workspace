...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-forty-three'),
    ('driehonderdvierentachtig', 'vierhonderddrieenveertig'),
    ('all_cases[:379]', 'all_cases[:428]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:428]'),
    ('!= 379', '!= 428'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-forty-three')).write_text(text)
