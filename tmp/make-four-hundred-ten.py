...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-ten'),
    ('driehonderdvierentachtig', 'vierhonderdtien'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-ten')).write_text(text)
