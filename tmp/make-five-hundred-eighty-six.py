...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-eighty-six'),
    ('driehonderdvierentachtig', 'vijfhonderdzesentachtig'),
    ('all_cases[:379]', 'all_cases[:571]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:571]'),
    ('!= 379', '!= 571'),
