...
repls = [
    ('three-hundred-eighty-seven', 'four-hundred-fifteen'),
    ('driehonderdzevenentachtig', 'vierhonderdvijftien'),
...
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'four-hundred-fifteen')).write_text(text)
