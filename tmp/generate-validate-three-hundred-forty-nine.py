...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-forty-nine'),
    ('tweehonderdnegenentwintig', 'driehonderdnegenenveertig'),
    ('[:227]', '[:345]'),
    ('!= 227', '!= 345'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-forty-nine-{kind}.py'
    text = src.read_text()
