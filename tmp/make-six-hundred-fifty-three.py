...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-fifty-three'),
    ('driehonderdvierentachtig', 'zeshonderddrieënvijftig'),
    ('all_cases[:379]', 'all_cases[:638]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:638]'),
    ('!= 379', '!= 638'),
