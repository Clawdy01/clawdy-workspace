...
repls = [
    ('four-hundred-sixty-three', 'four-hundred-seventy-two'),
    ('vierhonderddrieënzestig', 'vierhonderdtweeënzeventig'),
    ('[:448]', '[:457]'),
    ('!= 448', '!= 457'),
    ('kreeg 448', 'kreeg 457'),
]
for name in files:
    ...
    (root / name.replace('four-hundred-sixty-three', 'four-hundred-seventy-two')).write_text(text)
print('created')
