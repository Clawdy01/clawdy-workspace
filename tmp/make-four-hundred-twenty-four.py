...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-twenty-four'),
    ('driehonderdvierentachtig', 'vierhonderdvierentwintig'),
    ('all_cases[:379]', 'all_cases[:409]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:409]'),
    ('!= 379', '!= 409'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-twenty-four')).write_text(text)
