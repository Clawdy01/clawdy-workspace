...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-seventy-six'),
    ('driehonderdvierentachtig', 'vijfhonderdzesenzeventig'),
    ('all_cases[:379]', 'all_cases[:561]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:561]'),
    ('!= 379', '!= 561'),
