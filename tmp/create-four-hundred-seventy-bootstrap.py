...
repls = [
    ('four-hundred-fifty-eight', 'four-hundred-seventy'),
    ('vierhonderdachtenvijftig', 'vierhonderdzeventig'),
    ('all_cases[:443]', 'all_cases[:455]'),
    ('{UNKNOWN, TYPO}][:443]', '{UNKNOWN, TYPO}][:455]'),
    ('!= 443', '!= 455'),
    ('kreeg 443', 'kreeg 455'),
...
for src_name in [
    ...
    src = root / src_name
    dst = root / src_name.replace('four-hundred-fifty-eight', 'four-hundred-seventy')
    text = src.read_text()
