...
repls = [
    ('three-hundred-sixty-one', 'four-hundred-two'),
    ('driehonderdeenenzestig', 'vierhonderdtwee'),
    ('all_cases[:356]', 'all_cases[:397]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:397]'),
    ('!= 356', '!= 397'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-four-hundred-two-{kind}.py'
    text = src.read_text()
