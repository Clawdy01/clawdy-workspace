...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-forty-eight'),
    ('driehonderdvierentachtig', 'zeshonderdachtenveertig'),
    ('all_cases[:379]', 'all_cases[:633]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:633]'),
    ('!= 379', '!= 633'),
