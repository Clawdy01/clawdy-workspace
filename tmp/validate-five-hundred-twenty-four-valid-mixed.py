...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:509]
if len(valid_cases) != 509:
    raise SystemExit(f'kon geen vijfhonderdvierentwintig geldige casenamen vinden, kreeg {valid_cases}')
