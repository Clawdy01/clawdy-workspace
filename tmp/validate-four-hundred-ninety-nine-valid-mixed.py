...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:484]
if len(valid_cases) != 484:
    raise SystemExit(f'kon geen vierhonderdnegenennegentig geldige casenamen vinden, kreeg {valid_cases}')
