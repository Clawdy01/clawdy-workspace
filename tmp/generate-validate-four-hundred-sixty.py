...
repls = [
    ('three-hundred-sixty-one', 'four-hundred-sixty'),
    ('driehonderdeenenzestig', 'vierhonderdzestig'),
    ('all_cases[:356]', 'all_cases[:445]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:445]'),
    ('!= 356', '!= 445'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-four-hundred-sixty-{kind}.py'
    text = src.read_text()
