...
repls = [
    ('three-hundred-seventy-four', 'five-hundred-twenty-nine'),
    ('driehonderdvierenzeventig', 'vijfhonderdnegenentwintig'),
    ('all_cases[:369]', 'all_cases[:514]'),
    ('{UNKNOWN, TYPO}][:369]', '{UNKNOWN, TYPO}][:514]'),
    ('!= 369', '!= 514'),
