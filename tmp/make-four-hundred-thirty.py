...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-thirty'),
    ('driehonderdvierentachtig', 'vierhonderddertig'),
    ('all_cases[:379]', 'all_cases[:415]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:415]'),
    ('!= 379', '!= 415'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-thirty')).write_text(text)
