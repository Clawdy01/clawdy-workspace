...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-forty-three'),
    ('driehonderdvierentachtig', 'zeshonderddrieënveertig'),
    ('all_cases[:379]', 'all_cases[:628]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:628]'),
    ('!= 379', '!= 628'),
