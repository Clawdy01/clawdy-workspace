...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:481]
if len(valid_cases) != 481:
    raise SystemExit(f'kon geen vierhonderdzesennegentig geldige casenamen vinden, kreeg {valid_cases}')
