...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-thirty-five'),
    ('driehonderdvierentachtig', 'vijfhonderdvijfendertig'),
    ('all_cases[:379]', 'all_cases[:520]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:520]'),
    ('!= 379', '!= 520'),
