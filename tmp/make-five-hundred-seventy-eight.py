...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-seventy-eight'),
    ('driehonderdvierentachtig', 'vijfhonderdachtenzeventig'),
    ('all_cases[:379]', 'all_cases[:563]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:563]'),
    ('!= 379', '!= 563'),
