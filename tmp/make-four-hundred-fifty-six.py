...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-fifty-six'),
    ('driehonderdvierentachtig', 'vierhonderdzesenvijftig'),
    ('all_cases[:379]', 'all_cases[:441]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:441]'),
    ('!= 379', '!= 441'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-fifty-six')).write_text(text)
