...
repls = [
    ('three-hundred-sixty-one', 'four-hundred'),
    ('driehonderdeenenzestig', 'vierhonderd'),
    ('all_cases[:356]', 'all_cases[:395]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:395]'),
    ('!= 356', '!= 395'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-four-hundred-{kind}.py'
    text = src.read_text()
