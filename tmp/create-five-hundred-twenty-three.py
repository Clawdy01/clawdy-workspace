...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-twenty-three'),
    ('driehonderdnegenenzestig', 'vijfhonderddrieëntwintig'),
    ('all_cases[:364]', 'all_cases[:508]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:508]'),
    ('!= 364', '!= 508'),
