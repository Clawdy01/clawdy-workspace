...
repls = [
    ('four-hundred-fifty-eight', 'four-hundred-sixty-eight'),
    ('vierhonderdachtenvijftig', 'vierhonderdachtenzestig'),
    ('all_cases[:443]', 'all_cases[:453]'),
    ('{UNKNOWN, TYPO}][:443]', '{UNKNOWN, TYPO}][:453]'),
    ('!= 443', '!= 453'),
    ('kreeg 443', 'kreeg 453'),
...
for src_name in [
    ...
    src = root / src_name
    dst = root / src_name.replace('four-hundred-fifty-eight', 'four-hundred-sixty-eight')
    text = src.read_text()
