...
repls = [
    ...
    ('driehonderdeenenvijftig', 'driehonderdtweeënvijftig'),
    ('[:347]', '[:348]'),
    ('!= 347', '!= 348'),
    (' 342, 343, 344, 345, 346]', ' 342, 343, 344, 345, 346, 347]'),
]
...
for name in (
    ...
    src = root / 'tmp' / name
    dst = root / 'tmp' / name.replace('three-hundred-fifty-one', 'three-hundred-fifty-two')
    text = src.read_text()
