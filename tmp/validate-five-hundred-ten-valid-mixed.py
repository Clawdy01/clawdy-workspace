...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:495]
if len(valid_cases) != 495:
    raise SystemExit(f'kon geen vijfhonderdtien geldige casenamen vinden, kreeg {valid_cases}')
