...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-twenty-four'),
    ('tweehonderdnegenentwintig', 'driehonderdvierentwintig'),
    ('[:227]', '[:320]'),
    ('!= 227', '!= 320'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-twenty-four-{kind}.py'
    text = src.read_text()
