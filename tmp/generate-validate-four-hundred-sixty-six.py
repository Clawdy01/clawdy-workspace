...
repls = [
    ('three-hundred-sixty-one', 'four-hundred-sixty-six'),
    ('driehonderdeenenzestig', 'vierhonderdzesenzestig'),
    ('all_cases[:356]', 'all_cases[:451]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:451]'),
    ('!= 356', '!= 451'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-four-hundred-sixty-six-{kind}.py'
    text = src.read_text()
