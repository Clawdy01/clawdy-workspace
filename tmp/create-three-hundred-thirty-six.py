...
repls = [
    ('three-hundred-thirty-four', 'three-hundred-thirty-six'),
    ('driehonderdvierendertig', 'driehonderdzesendertig'),
    ('[:330]', '[:332]'),
    ('!= 330', '!= 332'),
...
for name in (
    ...
    src = root / 'tmp' / name
    dst = root / 'tmp' / name.replace('three-hundred-thirty-four', 'three-hundred-thirty-six')
    text = src.read_text()
