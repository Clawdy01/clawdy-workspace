...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-eighty-one'),
    ('driehonderdvierentachtig', 'vijfhonderdeenentachtig'),
    ('all_cases[:379]', 'all_cases[:566]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:566]'),
    ('!= 379', '!= 566'),
