...
repls = [
    ('three-hundred-seventy-four', 'five-hundred-thirty-five'),
    ('driehonderdvierenzeventig', 'vijfhonderdvijfendertig'),
    ('all_cases[:369]', 'all_cases[:520]'),
    ('{UNKNOWN, TYPO}][:369]', '{UNKNOWN, TYPO}][:520]'),
    ('!= 369', '!= 520'),
