...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:500]
if len(valid_cases) != 500:
    raise SystemExit(f'kon geen vijfhonderdvijftien geldige casenamen vinden, kreeg {valid_cases}')
