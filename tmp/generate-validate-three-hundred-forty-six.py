...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-forty-six'),
    ('tweehonderdnegenentwintig', 'driehonderdzesenveertig'),
    ('[:227]', '[:342]'),
    ('!= 227', '!= 342'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-forty-six-{kind}.py'
    text = src.read_text()
