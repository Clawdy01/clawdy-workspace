...
repls = [
    ('three-hundred-sixty-one', 'four-hundred-sixty-two'),
    ('driehonderdeenenzestig', 'vierhonderdtweeënzestig'),
    ('all_cases[:356]', 'all_cases[:447]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:447]'),
    ('!= 356', '!= 447'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-four-hundred-sixty-two-{kind}.py'
    text = src.read_text()
