...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-twenty-two'),
    ('driehonderdvierentachtig', 'zeshonderdtweeëntwintig'),
    ('all_cases[:379]', 'all_cases[:607]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:607]'),
    ('!= 379', '!= 607'),
