...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-twenty-five'),
    ('driehonderdvierentachtig', 'vierhonderdvijfentwintig'),
    ('all_cases[:379]', 'all_cases[:410]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:410]'),
    ('!= 379', '!= 410'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-twenty-five')).write_text(text)
