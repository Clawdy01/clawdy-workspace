...
repls = [
    ('three-hundred-sixty-one', 'five-hundred-thirty-three'),
    ('driehonderdeenenzestig', 'vijfhonderddrieëndertig'),
    ('all_cases[:356]', 'all_cases[:518]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:518]'),
    ('!= 356', '!= 518'),
