...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:534]
if len(valid_cases) != 534:
    raise SystemExit(f'kon geen vijfhonderdnegenenveertig geldige casenamen vinden, kreeg {valid_cases}')
