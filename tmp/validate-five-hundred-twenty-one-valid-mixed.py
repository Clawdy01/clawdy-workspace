...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:506]
if len(valid_cases) != 506:
    raise SystemExit(f'kon geen vijfhonderdeenentwintig geldige casenamen vinden, kreeg {valid_cases}')
