...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-six'),
    ('driehonderdvierentachtig', 'vierhonderdzes'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-six')).write_text(text)
