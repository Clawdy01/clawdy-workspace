...
repls = [
    ('three-hundred-eighty-four', 'three-hundred-ninety-six'),
    ('driehonderdvierentachtig', 'driehonderdzesennegentig'),
    ('all_cases[:379]', 'all_cases[:391]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:391]'),
    ('!= 379', '!= 391'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'three-hundred-ninety-six')).write_text(text)
