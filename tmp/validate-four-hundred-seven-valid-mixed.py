...
if len(valid_cases) != 401:
    raise SystemExit(f'kon geen vierhonderdzeven geldige casenamen vinden, kreeg {valid_cases}')
...
if expected_stderr not in (plain_proc.stderr or ''):
    raise SystemExit('plain stderr noemt niet alle vierhonderdzeven geldige first-seen cases')
