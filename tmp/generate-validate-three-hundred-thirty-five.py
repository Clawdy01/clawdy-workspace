...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-thirty-five'),
    ('tweehonderdnegenentwintig', 'driehonderdvijfendertig'),
    ('[:227]', '[:331]'),
    ('!= 227', '!= 331'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-thirty-five-{kind}.py'
    text = src.read_text()
