...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-thirty-seven'),
    ('tweehonderdnegenentwintig', 'driehonderdzevenendertig'),
    ('[:227]', '[:333]'),
    ('!= 227', '!= 333'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-thirty-seven-{kind}.py'
    text = src.read_text()
