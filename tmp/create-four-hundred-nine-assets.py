...
repls = [
    ('three-hundred-eighty-seven', 'four-hundred-nine'),
    ('driehonderdzevenentachtig', 'vierhonderdnegen'),
...
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'four-hundred-nine')).write_text(text)
