...
repls = [
    ('three-hundred-sixty-one', 'four-hundred-seventy'),
    ('driehonderdeenenzestig', 'vierhonderdzeventig'),
    ('all_cases[:356]', 'all_cases[:455]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:455]'),
    ('!= 356', '!= 455'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-four-hundred-seventy-{kind}.py'
    text = src.read_text()
