...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-twelve'),
    ('driehonderdvierentachtig', 'vierhonderdtwaalf'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-twelve')).write_text(text)
