...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:512]
if len(valid_cases) != 512:
    raise SystemExit(f'kon geen vijfhonderdzevenentwintig geldige casenamen vinden, kreeg {valid_cases}')
