...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-twenty-five'),
    ('tweehonderdnegenentwintig', 'driehonderdvijfentwintig'),
    ('[:227]', '[:321]'),
    ('!= 227', '!= 321'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-twenty-five-{kind}.py'
    text = src.read_text()
