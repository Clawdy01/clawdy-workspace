...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-fifty-one'),
    ('tweehonderdnegenentwintig', 'driehonderdeenenvijftig'),
    ('[:227]', '[:347]'),
    ('!= 227', '!= 347'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-fifty-one-{kind}.py'
    text = src.read_text()
