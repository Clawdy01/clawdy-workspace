...
repls = [
    ('three-hundred-eighty-seven', 'three-hundred-ninety-eight'),
    ('driehonderdzevenentachtig', 'driehonderdachtennegentig'),
    ('all_cases[:382]', 'all_cases[:393]'),
    ('{UNKNOWN, TYPO}][:382]', '{UNKNOWN, TYPO}][:393]'),
    ('!= 382', '!= 393'),
...
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'three-hundred-ninety-eight')).write_text(text)
