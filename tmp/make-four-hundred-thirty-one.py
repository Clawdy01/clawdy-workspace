...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-thirty-one'),
    ('driehonderdvierentachtig', 'vierhonderdeenendertig'),
    ('all_cases[:379]', 'all_cases[:416]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:416]'),
    ('!= 379', '!= 416'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-thirty-one')).write_text(text)
