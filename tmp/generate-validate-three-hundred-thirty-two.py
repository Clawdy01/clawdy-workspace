...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-thirty-two'),
    ('tweehonderdnegenentwintig', 'driehonderdtweeëndertig'),
    ('[:227]', '[:328]'),
    ('!= 227', '!= 328'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-thirty-two-{kind}.py'
    text = src.read_text()
