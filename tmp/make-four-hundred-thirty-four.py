...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-thirty-four'),
    ('driehonderdvierentachtig', 'vierhonderdvierendertig'),
    ('all_cases[:379]', 'all_cases[:419]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:419]'),
    ('!= 379', '!= 419'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-thirty-four')).write_text(text)
