...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-thirty-seven'),
    ('driehonderdvierentachtig', 'vijfhonderdzevenendertig'),
    ('all_cases[:379]', 'all_cases[:522]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:522]'),
    ('!= 379', '!= 522'),
