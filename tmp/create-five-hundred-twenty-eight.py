...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-twenty-eight'),
    ('driehonderdnegenenzestig', 'vijfhonderdachtentwintig'),
    ('all_cases[:364]', 'all_cases[:513]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:513]'),
    ('!= 364', '!= 513'),
