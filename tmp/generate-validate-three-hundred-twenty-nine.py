...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-twenty-nine'),
    ('tweehonderdnegenentwintig', 'driehonderdnegenentwintig'),
    ('[:227]', '[:325]'),
    ('!= 227', '!= 325'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-twenty-nine-{kind}.py'
    text = src.read_text()
