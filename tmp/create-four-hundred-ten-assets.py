...
repls = [
    ('three-hundred-eighty-seven', 'four-hundred-ten'),
    ('driehonderdzevenentachtig', 'vierhonderdtien'),
...
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'four-hundred-ten')).write_text(text)
