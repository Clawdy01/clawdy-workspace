...
repls = [
    ('three-hundred-sixty-one', 'four-hundred-seventy-nine'),
    ('driehonderdeenenzestig', 'vierhonderdnegenenzeventig'),
    ('all_cases[:356]', 'all_cases[:464]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:464]'),
    ('!= 356', '!= 464'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-four-hundred-seventy-nine-{kind}.py'
    text = src.read_text()
