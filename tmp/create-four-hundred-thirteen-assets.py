...
repls = [
    ('three-hundred-eighty-seven', 'four-hundred-thirteen'),
    ('driehonderdzevenentachtig', 'vierhonderddertien'),
...
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'four-hundred-thirteen')).write_text(text)
