...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-thirty-eight'),
    ('driehonderdvierentachtig', 'vijfhonderdachtendertig'),
    ('all_cases[:379]', 'all_cases[:523]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:523]'),
    ('!= 379', '!= 523'),
