...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-thirty-six'),
    ('tweehonderdnegenentwintig', 'driehonderdzesendertig'),
    ('[:227]', '[:332]'),
    ('!= 227', '!= 332'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-thirty-six-{kind}.py'
    text = src.read_text()
