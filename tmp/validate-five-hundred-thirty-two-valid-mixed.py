...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:517]
if len(valid_cases) != 517:
    raise SystemExit(f'kon geen vijfhonderdtweeëndertig geldige casenamen vinden, kreeg {valid_cases}')
