...
repls = [
    ('four-hundred-fifty-eight', 'four-hundred-sixty'),
    ('vierhonderdachtenvijftig', 'vierhonderdzestig'),
    ('all_cases[:443]', 'all_cases[:445]'),
    ('{UNKNOWN, TYPO}][:443]', '{UNKNOWN, TYPO}][:445]'),
    ('!= 443', '!= 445'),
    ('kreeg 443', 'kreeg 445'),
...
for src_name in [
    ...
    src = root / src_name
    dst = root / src_name.replace('four-hundred-fifty-eight', 'four-hundred-sixty')
    text = src.read_text()
