...
repls = [
    ('three-hundred-sixty-nine', 'four-hundred-sixteen'),
    ('driehonderdnegenenzestig', 'vierhonderdzestien'),
...
for name in (
    ...
    src = root / 'tmp' / name
    dst = root / 'tmp' / name.replace('three-hundred-sixty-nine', 'four-hundred-sixteen')
    text = src.read_text()
