...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-eighteen'),
    ('driehonderdnegenenzestig', 'vijfhonderdachttien'),
    ('all_cases[:364]', 'all_cases[:503]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:503]'),
    ('!= 364', '!= 503'),
