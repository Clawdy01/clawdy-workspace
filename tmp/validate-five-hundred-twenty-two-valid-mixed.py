...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:507]
if len(valid_cases) != 507:
    raise SystemExit(f'kon geen vijfhonderdtweeëntwintig geldige casenamen vinden, kreeg {valid_cases}')
