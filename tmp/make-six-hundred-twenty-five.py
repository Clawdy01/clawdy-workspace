...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-twenty-five'),
    ('driehonderdvierentachtig', 'zeshonderdvijfentwintig'),
    ('all_cases[:379]', 'all_cases[:610]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:610]'),
    ('!= 379', '!= 610'),
