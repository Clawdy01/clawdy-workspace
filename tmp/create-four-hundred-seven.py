...
repls = [
    ('three-hundred-sixty-nine', 'four-hundred-seven'),
    ('driehonderdnegenenzestig', 'vierhonderdzeven'),
...
for name in (
    ...
    src = root / 'tmp' / name
    dst = root / 'tmp' / name.replace('three-hundred-sixty-nine', 'four-hundred-seven')
    text = src.read_text()
