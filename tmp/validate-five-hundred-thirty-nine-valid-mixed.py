...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:524]
if len(valid_cases) != 524:
    raise SystemExit(f'kon geen vijfhonderdnegenendertig geldige casenamen vinden, kreeg {valid_cases}')
