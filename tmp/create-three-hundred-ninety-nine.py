...
repls = [
    ('three-hundred-sixty-nine', 'three-hundred-ninety-nine'),
    ('driehonderdnegenenzestig', 'driehonderdnegenennegentig'),
    ('all_cases[:364]', 'all_cases[:394]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:394]'),
    ('!= 364', '!= 394'),
...
for name in (
    ...
    src = root / 'tmp' / name
    dst = root / 'tmp' / name.replace('three-hundred-sixty-nine', 'three-hundred-ninety-nine')
    text = src.read_text()
