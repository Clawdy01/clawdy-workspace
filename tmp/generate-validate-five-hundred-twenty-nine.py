...
repls = [
    ('three-hundred-sixty-one', 'five-hundred-twenty-nine'),
    ('driehonderdeenenzestig', 'vijfhonderdnegenentwintig'),
    ('all_cases[:356]', 'all_cases[:514]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:514]'),
    ('!= 356', '!= 514'),
