...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-fifty-three'),
    ('driehonderdvierentachtig', 'vijfhonderddrieënvijftig'),
    ('all_cases[:379]', 'all_cases[:538]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:538]'),
    ('!= 379', '!= 538'),
