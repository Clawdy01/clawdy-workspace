...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-forty-four'),
    ('tweehonderdnegenentwintig', 'driehonderdvierenveertig'),
    ('[:227]', '[:340]'),
    ('!= 227', '!= 340'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-forty-four-{kind}.py'
    text = src.read_text()
