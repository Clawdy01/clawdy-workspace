...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:519]
if len(valid_cases) != 519:
    raise SystemExit(f'kon geen vijfhonderdvierendertig geldige casenamen vinden, kreeg {valid_cases}')
