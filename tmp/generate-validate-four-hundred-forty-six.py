...
repls = [
    ('three-hundred-sixty-one', 'four-hundred-forty-six'),
    ('driehonderdeenenzestig', 'vierhonderdzesenveertig'),
    ('all_cases[:356]', 'all_cases[:431]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:431]'),
    ('!= 356', '!= 431'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-four-hundred-forty-six-{kind}.py'
    text = src.read_text()
