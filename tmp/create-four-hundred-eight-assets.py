...
repls = [
    ('three-hundred-eighty-seven', 'four-hundred-eight'),
    ('driehonderdzevenentachtig', 'vierhonderdacht'),
...
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'four-hundred-eight')).write_text(text)
