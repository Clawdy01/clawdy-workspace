...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-thirty-three'),
    ('driehonderdvierentachtig', 'vijfhonderddrieëndertig'),
    ('all_cases[:379]', 'all_cases[:518]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:518]'),
    ('!= 379', '!= 518'),
