...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-thirty-one'),
    ('driehonderdvierentachtig', 'vijfhonderdeenendertig'),
    ('all_cases[:379]', 'all_cases[:516]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:516]'),
    ('!= 379', '!= 516'),
