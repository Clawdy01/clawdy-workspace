...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:508]
if len(valid_cases) != 508:
    raise SystemExit(f'kon geen vijfhonderddrieëntwintig geldige casenamen vinden, kreeg {valid_cases}')
