...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:478]
if len(valid_cases) != 478:
    raise SystemExit(f'kon geen vierhonderddrieënnegentig geldige casenamen vinden, kreeg {valid_cases}')
