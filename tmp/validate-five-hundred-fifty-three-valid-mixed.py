...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:538]
if len(valid_cases) != 538:
    raise SystemExit(f'kon geen vijfhonderddrieënvijftig geldige casenamen vinden, kreeg {valid_cases}')
