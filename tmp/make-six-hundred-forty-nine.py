...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-forty-nine'),
    ('driehonderdvierentachtig', 'zeshonderdnegenenveertig'),
    ('all_cases[:379]', 'all_cases[:634]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:634]'),
    ('!= 379', '!= 634'),
