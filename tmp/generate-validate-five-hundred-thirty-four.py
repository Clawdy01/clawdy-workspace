...
repls = [
    ('three-hundred-sixty-one', 'five-hundred-thirty-four'),
    ('driehonderdeenenzestig', 'vijfhonderdvierendertig'),
    ('all_cases[:356]', 'all_cases[:519]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:519]'),
    ('!= 356', '!= 519'),
