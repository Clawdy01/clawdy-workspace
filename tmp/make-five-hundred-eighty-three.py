...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-eighty-three'),
    ('driehonderdvierentachtig', 'vijfhonderddrieëntachtig'),
    ('all_cases[:379]', 'all_cases[:568]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:568]'),
    ('!= 379', '!= 568'),
