...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-eighty-two'),
    ('driehonderdvierentachtig', 'vijfhonderdtweeëntachtig'),
    ('all_cases[:379]', 'all_cases[:567]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:567]'),
    ('!= 379', '!= 567'),
