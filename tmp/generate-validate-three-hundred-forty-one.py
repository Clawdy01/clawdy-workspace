...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-forty-one'),
    ('tweehonderdnegenentwintig', 'driehonderdeenenveertig'),
    ('[:227]', '[:337]'),
    ('!= 227', '!= 337'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-forty-one-{kind}.py'
    text = src.read_text()
