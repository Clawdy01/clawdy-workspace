...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-fifty-five'),
    ('tweehonderdnegenentwintig', 'driehonderdvijfenvijftig'),
    ('[:227]', '[:351]'),
    ('!= 227', '!= 351'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-fifty-five-{kind}.py'
    text = src.read_text()
