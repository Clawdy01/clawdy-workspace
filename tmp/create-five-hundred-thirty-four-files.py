...
repls = [
    ('three-hundred-seventy-four', 'five-hundred-thirty-four'),
    ('driehonderdvierenzeventig', 'vijfhonderdvierendertig'),
    ('all_cases[:369]', 'all_cases[:519]'),
    ('{UNKNOWN, TYPO}][:369]', '{UNKNOWN, TYPO}][:519]'),
    ('!= 369', '!= 519'),
