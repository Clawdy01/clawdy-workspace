...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-forty-five'),
    ('driehonderdvierentachtig', 'vijfhonderdvijfenveertig'),
    ('all_cases[:379]', 'all_cases[:530]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:530]'),
    ('!= 379', '!= 530'),
