...
repls = [
    ('three-hundred-seventy-four', 'six-hundred-thirty-six'),
    ('driehonderdvierenzeventig', 'zeshonderdzesendertig'),
    ('all_cases[:369]', 'all_cases[:621]'),
    ('{UNKNOWN, TYPO}][:369]', '{UNKNOWN, TYPO}][:621]'),
    ('!= 369', '!= 621'),
