...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-ninety-six'),
    ('driehonderdvierentachtig', 'vijfhonderdzesennegentig'),
    ('all_cases[:379]', 'all_cases[:581]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:581]'),
    ('!= 379', '!= 581'),
