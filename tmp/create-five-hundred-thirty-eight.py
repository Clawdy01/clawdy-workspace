...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-thirty-eight'),
    ('driehonderdnegenenzestig', 'vijfhonderdachtendertig'),
    ('all_cases[:364]', 'all_cases[:523]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:523]'),
    ('!= 364', '!= 523'),
