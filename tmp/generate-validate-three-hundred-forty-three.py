...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-forty-three'),
    ('tweehonderdnegenentwintig', 'driehonderddrieenveertig'),
    ('[:227]', '[:339]'),
    ('!= 227', '!= 339'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-forty-three-{kind}.py'
    text = src.read_text()
