...
repls = [
    ('three-hundred-eighty-four', 'three-hundred-ninety-four'),
    ('driehonderdvierentachtig', 'driehonderdvierennegentig'),
    ('all_cases[:379]', 'all_cases[:389]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:389]'),
    ('!= 379', '!= 389'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'three-hundred-ninety-four')).write_text(text)
