...
repls = [
    ('three-hundred-eighty-seven', 'four-hundred-fourteen'),
    ('driehonderdzevenentachtig', 'vierhonderdveertien'),
...
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'four-hundred-fourteen')).write_text(text)
