...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-twenty-nine'),
    ('driehonderdnegenenzestig', 'vijfhonderdnegenentwintig'),
    ('all_cases[:364]', 'all_cases[:514]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:514]'),
    ('!= 364', '!= 514'),
