...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-fifty'),
    ('driehonderdvierentachtig', 'vierhonderdvijftig'),
    ('all_cases[:379]', 'all_cases[:435]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:435]'),
    ('!= 379', '!= 435'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-fifty')).write_text(text)
