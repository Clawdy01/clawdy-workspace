...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-eighty-nine'),
    ('driehonderdvierentachtig', 'vierhonderdnegenentachtig'),
    ('all_cases[:379]', 'all_cases[:474]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:474]'),
    ('!= 379', '!= 474'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-eighty-nine')).write_text(text)
