...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-forty-seven'),
    ('driehonderdvierentachtig', 'vijfhonderdzevenenveertig'),
    ('all_cases[:379]', 'all_cases[:532]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:532]'),
    ('!= 379', '!= 532'),
