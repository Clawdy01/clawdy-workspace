...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-fifty-seven'),
    ('driehonderdvierentachtig', 'vierhonderdzevenenvijftig'),
    ('all_cases[:379]', 'all_cases[:442]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:442]'),
    ('!= 379', '!= 442'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-fifty-seven')).write_text(text)
