...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:497]
if len(valid_cases) != 497:
    raise SystemExit(f'kon geen vijfhonderdtwaalf geldige casenamen vinden, kreeg {valid_cases}')
