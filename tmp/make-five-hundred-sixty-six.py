...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-sixty-six'),
    ('driehonderdvierentachtig', 'vijfhonderdzesenzestig'),
    ('all_cases[:379]', 'all_cases[:551]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:551]'),
    ('!= 379', '!= 551'),
