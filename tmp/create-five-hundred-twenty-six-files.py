...
repls = [
    ('three-hundred-seventy-four', 'five-hundred-twenty-six'),
    ('driehonderdvierenzeventig', 'vijfhonderdzesentwintig'),
    ('all_cases[:369]', 'all_cases[:511]'),
    ('{UNKNOWN, TYPO}][:369]', '{UNKNOWN, TYPO}][:511]'),
    ('!= 369', '!= 511'),
