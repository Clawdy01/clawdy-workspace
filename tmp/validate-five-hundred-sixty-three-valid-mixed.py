...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:548]
if len(valid_cases) != 548:
    raise SystemExit(f'kon geen vijfhonderddrieënzestig geldige casenamen vinden, kreeg {valid_cases}')
