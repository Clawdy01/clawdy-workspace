...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:491]
if len(valid_cases) != 491:
    raise SystemExit(f'kon geen vijfhonderdzes geldige casenamen vinden, kreeg {valid_cases}')
