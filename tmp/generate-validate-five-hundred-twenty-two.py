...
repls = [
    ('three-hundred-sixty-one', 'five-hundred-twenty-two'),
    ('driehonderdeenenzestig', 'vijfhonderdtweeëntwintig'),
    ('all_cases[:356]', 'all_cases[:507]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:507]'),
    ('!= 356', '!= 507'),
