...
repls = [
    ('four-hundred-fifty-eight', 'five-hundred-four'),
    ('vierhonderdachtenvijftig', 'vijfhonderdvier'),
    ('all_cases[:443]', 'all_cases[:489]'),
    ('{UNKNOWN, TYPO}][:443]', '{UNKNOWN, TYPO}][:489]'),
    ('!= 443', '!= 489'),
    ('kreeg 443', 'kreeg 489'),
    (', 430, 431, 432, 433, 434, 435, 436, 437, 438, 439, 440, 441, 442]', ', 430, 431, 432, 433, 434, 435, 436, 437, 438, 439, 440, 441, 442, 443, 444, 445, 446, 447, 448, 449, 450, 451, 452, 453, 454, 455, 456, 457, 458, 459, 460, 461, 462, 463, 464, 465, 466, 467, 468, 469, 470, 471, 472, 473, 474, 475, 476, 477]'),
]
for src_name in [
