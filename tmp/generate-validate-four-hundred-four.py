...
repls = [
    ('three-hundred-sixty-one', 'four-hundred-four'),
    ('driehonderdeenenzestig', 'vierhonderdvier'),
    ('all_cases[:356]', 'all_cases[:399]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:399]'),
    ('!= 356', '!= 399'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-four-hundred-four-{kind}.py'
    text = src.read_text()
