...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-forty-five'),
    ('driehonderdvierentachtig', 'zeshonderdvijfenveertig'),
    ('all_cases[:379]', 'all_cases[:630]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:630]'),
    ('!= 379', '!= 630'),
