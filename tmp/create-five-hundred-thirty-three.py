...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-thirty-three'),
    ('driehonderdnegenenzestig', 'vijfhonderddrieëndertig'),
    ('all_cases[:364]', 'all_cases[:518]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:518]'),
    ('!= 364', '!= 518'),
