...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-fifty-two'),
    ('driehonderdvierentachtig', 'vierhonderdtweeënvijftig'),
    ('all_cases[:379]', 'all_cases[:437]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:437]'),
    ('!= 379', '!= 437'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-fifty-two')).write_text(text)
