...
repls = [
    ('three-hundred-seventy-four', 'five-hundred-thirty-nine'),
    ('driehonderdvierenzeventig', 'vijfhonderdnegenendertig'),
    ('all_cases[:369]', 'all_cases[:524]'),
    ('{UNKNOWN, TYPO}][:369]', '{UNKNOWN, TYPO}][:524]'),
    ('!= 369', '!= 524'),
