...
repls = [
    ('three-hundred-sixty-one', 'four-hundred-twenty'),
    ('driehonderdeenenzestig', 'vierhonderdtwintig'),
    ('all_cases[:356]', 'all_cases[:405]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:405]'),
    ('!= 356', '!= 405'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-four-hundred-twenty-{kind}.py'
    text = src.read_text()
