...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-seventy-three'),
    ('driehonderdvierentachtig', 'vierhonderddrieënzeventig'),
    ('all_cases[:379]', 'all_cases[:458]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:458]'),
    ('!= 379', '!= 458'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-seventy-three')).write_text(text)
