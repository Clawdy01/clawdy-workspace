...
repls = [
    ('three-hundred-sixty-nine', 'four-hundred-fifteen'),
    ('driehonderdnegenenzestig', 'vierhonderdvijftien'),
...
for name in (
    ...
    src = root / 'tmp' / name
    dst = root / 'tmp' / name.replace('three-hundred-sixty-nine', 'four-hundred-fifteen')
    text = src.read_text()
