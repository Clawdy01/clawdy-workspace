...
repls = [
    ('four-hundred-sixty-three', 'four-hundred-seventy-nine'),
    ('vierhonderddrieënzestig', 'vierhonderdnegenenzeventig'),
    ('[:448]', '[:464]'),
    ('!= 448', '!= 464'),
    ('kreeg 448', 'kreeg 464'),
]
for name in files:
    ...
    (root / name.replace('four-hundred-sixty-three', 'four-hundred-seventy-nine')).write_text(text)
print('created')
