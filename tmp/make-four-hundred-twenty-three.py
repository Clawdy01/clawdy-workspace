...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-twenty-three'),
    ('driehonderdvierentachtig', 'vierhonderddrieentwintig'),
    ('all_cases[:379]', 'all_cases[:408]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:408]'),
    ('!= 379', '!= 408'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-twenty-three')).write_text(text)
