...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-nineteen'),
    ('driehonderdvierentachtig', 'zeshonderdnegentien'),
    ('all_cases[:379]', 'all_cases[:604]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:604]'),
    ('!= 379', '!= 604'),
