...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-forty-two'),
    ('driehonderdvierentachtig', 'zeshonderdtweeënveertig'),
    ('all_cases[:379]', 'all_cases[:627]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:627]'),
    ('!= 379', '!= 627'),
