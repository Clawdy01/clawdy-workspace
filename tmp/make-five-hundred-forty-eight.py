...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-forty-eight'),
    ('driehonderdvierentachtig', 'vijfhonderdachtenveertig'),
    ('all_cases[:379]', 'all_cases[:533]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:533]'),
    ('!= 379', '!= 533'),
