...
repls = [
    ('three-hundred-eighty-seven', 'four-hundred-eleven'),
    ('driehonderdzevenentachtig', 'vierhonderdelf'),
...
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'four-hundred-eleven')).write_text(text)
