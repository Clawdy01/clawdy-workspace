...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-twenty-seven'),
    ('tweehonderdnegenentwintig', 'driehonderdzevenentwintig'),
    ('[:227]', '[:323]'),
    ('!= 227', '!= 323'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-twenty-seven-{kind}.py'
    text = src.read_text()
