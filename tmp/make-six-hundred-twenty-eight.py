...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-twenty-eight'),
    ('driehonderdvierentachtig', 'zeshonderdachtentwintig'),
    ('all_cases[:379]', 'all_cases[:613]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:613]'),
    ('!= 379', '!= 613'),
