...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-twenty-seven'),
    ('driehonderdvierentachtig', 'zeshonderdzevenentwintig'),
    ('all_cases[:379]', 'all_cases[:612]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:612]'),
    ('!= 379', '!= 612'),
