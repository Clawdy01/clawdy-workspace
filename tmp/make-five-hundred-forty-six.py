...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-forty-six'),
    ('driehonderdvierentachtig', 'vijfhonderdzesenveertig'),
    ('all_cases[:379]', 'all_cases[:531]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:531]'),
    ('!= 379', '!= 531'),
