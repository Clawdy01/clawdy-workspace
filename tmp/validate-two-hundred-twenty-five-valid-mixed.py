...
if len(valid_cases) != 223:
    raise SystemExit(f'kon geen tweehonderdvijfentwintig geldige casenamen vinden, kreeg {valid_cases}')
...
if expected_stderr not in (plain_proc.stderr or ''):
    raise SystemExit('plain stderr noemt niet alle tweehonderdvijfentwintig geldige first-seen cases')
