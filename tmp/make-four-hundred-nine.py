...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-nine'),
    ('driehonderdvierentachtig', 'vierhonderdnegen'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-nine')).write_text(text)
