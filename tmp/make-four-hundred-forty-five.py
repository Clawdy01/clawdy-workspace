...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-forty-five'),
    ('driehonderdvierentachtig', 'vierhonderdvijfenveertig'),
    ('all_cases[:379]', 'all_cases[:430]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:430]'),
    ('!= 379', '!= 430'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-forty-five')).write_text(text)
