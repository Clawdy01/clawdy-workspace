...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-forty-two'),
    ('driehonderdvierentachtig', 'vijfhonderdtweeënveertig'),
    ('all_cases[:379]', 'all_cases[:527]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:527]'),
    ('!= 379', '!= 527'),
