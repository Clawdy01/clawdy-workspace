...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:486]
if len(valid_cases) != 486:
    raise SystemExit(f'kon geen vijfhonderdeen geldige casenamen vinden, kreeg {valid_cases}')
