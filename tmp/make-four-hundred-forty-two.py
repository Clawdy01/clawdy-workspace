...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-forty-two'),
    ('driehonderdvierentachtig', 'vierhonderdtweeenveertig'),
    ('all_cases[:379]', 'all_cases[:427]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:427]'),
    ('!= 379', '!= 427'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-forty-two')).write_text(text)
