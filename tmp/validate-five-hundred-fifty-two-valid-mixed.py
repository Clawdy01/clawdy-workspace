...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:537]
if len(valid_cases) != 537:
    raise SystemExit(f'kon geen vijfhonderdtweeënvijftig geldige casenamen vinden, kreeg {valid_cases}')
