...
repls = [
    ('four-hundred-fifty-eight', 'four-hundred-sixty-three'),
    ('vierhonderdachtenvijftig', 'vierhonderddrieënzestig'),
    ('all_cases[:443]', 'all_cases[:448]'),
    ('{UNKNOWN, TYPO}][:443]', '{UNKNOWN, TYPO}][:448]'),
    ('!= 443', '!= 448'),
    ('kreeg 443', 'kreeg 448'),
...
for src_name in [
    ...
    src = root / src_name
    dst = root / src_name.replace('four-hundred-fifty-eight', 'four-hundred-sixty-three')
    text = src.read_text()
