...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-fifty-four'),
    ('driehonderdvierentachtig', 'vijfhonderdvierenvijftig'),
    ('all_cases[:379]', 'all_cases[:539]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:539]'),
    ('!= 379', '!= 539'),
