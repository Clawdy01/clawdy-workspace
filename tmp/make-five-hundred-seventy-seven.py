...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-seventy-seven'),
    ('driehonderdvierentachtig', 'vijfhonderdzevenenzeventig'),
    ('all_cases[:379]', 'all_cases[:562]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:562]'),
    ('!= 379', '!= 562'),
