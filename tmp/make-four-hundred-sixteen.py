...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-sixteen'),
    ('driehonderdvierentachtig', 'vierhonderdzestien'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-sixteen')).write_text(text)
