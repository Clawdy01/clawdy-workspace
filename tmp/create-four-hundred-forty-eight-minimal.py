...
repls = [
    ('four-hundred-thirty-four', 'four-hundred-forty-eight'),
    ('vierhonderdvierendertig', 'vierhonderdachtenveertig'),
    ('[:424]', '[:424]'),
    ('!= 422', '!= 433'),
    ('kreeg 422', 'kreeg 433'),
    (' 419)', ' 420)'),
    (', 413, 414, 415, 416, 417, 418]', ', 413, 414, 415, 416, 417, 418, 419, 420, 421, 422, 423, 424, 425, 426, 427, 428, 429, 430, 431, 432]'),
]
for name in files:
    text = (root / name).read_text()
    for old, new in repls:
        text = text.replace(old, new)
    (root / name.replace('four-hundred-thirty-four', 'four-hundred-forty-eight')).write_text(text)
