...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:554]
if len(valid_cases) != 554:
    raise SystemExit(f'kon geen vijfhonderdnegenenzestig geldige casenamen vinden, kreeg {valid_cases}')
