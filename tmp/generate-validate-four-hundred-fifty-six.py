...
repls = [
    ('three-hundred-sixty-one', 'four-hundred-fifty-six'),
    ('driehonderdeenenzestig', 'vierhonderdzesenvijftig'),
    ('all_cases[:356]', 'all_cases[:441]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:441]'),
    ('!= 356', '!= 441'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-four-hundred-fifty-six-{kind}.py'
    text = src.read_text()
