...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-eighteen'),
    ('driehonderdvierentachtig', 'vierhonderdachttien'),
    ('all_cases[:379]', 'all_cases[:403]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:403]'),
    ('!= 379', '!= 403'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-eighteen')).write_text(text)
