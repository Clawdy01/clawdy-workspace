...
repls = [
    ('four-hundred-thirty-four', 'four-hundred-thirty-seven'),
    ('vierhonderdvierendertig', 'vierhonderdzevenendertig'),
    ('[:421]', '[:421]'),
    ('!= 421', '!= 422'),
    ('kreeg 421', 'kreeg 422'),
    (' 419)', ' 420)'),
    (', 413, 414, 415, 416, 417, 418]', ', 413, 414, 415, 416, 417, 418, 419, 420, 421]'),
]
for name in files:
    text = (root / name).read_text()
    for old, new in repls:
        text = text.replace(old, new)
    (root / name.replace('four-hundred-thirty-four', 'four-hundred-thirty-seven')).write_text(text)
