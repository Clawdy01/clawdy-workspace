...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-twenty-six'),
    ('driehonderdvierentachtig', 'zeshonderdzesentwintig'),
    ('all_cases[:379]', 'all_cases[:611]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:611]'),
    ('!= 379', '!= 611'),
