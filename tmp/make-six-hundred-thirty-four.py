...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-thirty-four'),
    ('driehonderdvierentachtig', 'zeshonderdvierendertig'),
    ('all_cases[:379]', 'all_cases[:619]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:619]'),
    ('!= 379', '!= 619'),
