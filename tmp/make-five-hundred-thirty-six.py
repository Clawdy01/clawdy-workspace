...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-thirty-six'),
    ('driehonderdvierentachtig', 'vijfhonderdzesendertig'),
    ('all_cases[:379]', 'all_cases[:521]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:521]'),
    ('!= 379', '!= 521'),
