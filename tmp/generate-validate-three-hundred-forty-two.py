...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-forty-two'),
    ('tweehonderdnegenentwintig', 'driehonderdtweeenveertig'),
    ('[:227]', '[:338]'),
    ('!= 227', '!= 338'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-forty-two-{kind}.py'
    text = src.read_text()
