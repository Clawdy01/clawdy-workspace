...
base_repls = [
    ('four-hundred-seventy-seven', 'four-hundred-seventy-nine'),
    ('vierhonderdzevenenzeventig', 'vierhonderdnegenenzeventig'),
]
per_file = {
    'create-four-hundred-seventy-seven-assets.py': [
        ('[:462]', '[:464]'),
    ...
    'create-four-hundred-seventy-seven-bootstrap.py': [
        ('all_cases[:462]', 'all_cases[:464]'),
        ('{UNKNOWN, TYPO}][:462]', '{UNKNOWN, TYPO}][:464]'),
        ('!= 462', '!= 464'),
        ('kreeg 462', 'kreeg 464'),
    ...
    'validate-four-hundred-seventy-seven-valid-list-cases.py': [
        ...
        ('all_cases[:462]', 'all_cases[:464]'),
        ('len(valid_cases) != 462', 'len(valid_cases) != 464'),
    ],
    'validate-four-hundred-seventy-seven-valid-mixed.py': [
        (', 444, 445, 446, 447, 448, 449, 450, 451]', ', 444, 445, 446, 447, 448, 449, 450, 451, 452]'),
        ('[:462]', '[:464]'),
...
for name in files:
    ...
    for old, new in per_file[name]:
        ...
        text = text.replace(old, new)
    out = root / name.replace('four-hundred-seventy-seven', 'four-hundred-seventy-nine')
    out.write_text(text)
    print(out.name)
