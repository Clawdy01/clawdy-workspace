...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:522]
if len(valid_cases) != 522:
    raise SystemExit(f'kon geen vijfhonderdzevenendertig geldige casenamen vinden, kreeg {valid_cases}')
