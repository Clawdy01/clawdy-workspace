...
repls = [
    ('three-hundred-eighty-seven', 'four-hundred-three'),
    ('driehonderdzevenentachtig', 'vierhonderddrie'),
    ('all_cases[:382]', 'all_cases[:398]'),
    ('{UNKNOWN, TYPO}][:382]', '{UNKNOWN, TYPO}][:398]'),
    ('!= 382', '!= 398'),
...
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'four-hundred-three')).write_text(text)
