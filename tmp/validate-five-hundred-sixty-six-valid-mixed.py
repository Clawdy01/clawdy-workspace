...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:551]
if len(valid_cases) != 551:
    raise SystemExit(f'kon geen vijfhonderdzesenzestig geldige casenamen vinden, kreeg {valid_cases}')
