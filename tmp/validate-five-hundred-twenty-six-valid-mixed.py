...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:511]
if len(valid_cases) != 511:
    raise SystemExit(f'kon geen vijfhonderdzesentwintig geldige casenamen vinden, kreeg {valid_cases}')
