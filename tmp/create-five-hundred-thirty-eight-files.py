...
repls = [
    ('three-hundred-seventy-four', 'five-hundred-thirty-eight'),
    ('driehonderdvierenzeventig', 'vijfhonderdachtendertig'),
    ('all_cases[:369]', 'all_cases[:523]'),
    ('{UNKNOWN, TYPO}][:369]', '{UNKNOWN, TYPO}][:523]'),
    ('!= 369', '!= 523'),
