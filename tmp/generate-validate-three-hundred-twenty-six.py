...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-twenty-six'),
    ('tweehonderdnegenentwintig', 'driehonderdzesentwintig'),
    ('[:227]', '[:322]'),
    ('!= 227', '!= 322'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-twenty-six-{kind}.py'
    text = src.read_text()
