...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-sixty-eight'),
    ('driehonderdvierentachtig', 'vierhonderdachtenzestig'),
    ('all_cases[:379]', 'all_cases[:453]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:453]'),
    ('!= 379', '!= 453'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-sixty-eight')).write_text(text)
