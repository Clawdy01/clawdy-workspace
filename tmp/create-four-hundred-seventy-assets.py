...
repls = [
    ('four-hundred-sixty-three', 'four-hundred-seventy'),
    ('vierhonderddrieënzestig', 'vierhonderdzeventig'),
    ('[:448]', '[:455]'),
    ('!= 448', '!= 455'),
    ('kreeg 448', 'kreeg 455'),
]
for name in files:
    ...
    (root / name.replace('four-hundred-sixty-three', 'four-hundred-seventy')).write_text(text)
print('created')
