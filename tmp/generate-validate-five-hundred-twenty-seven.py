...
repls = [
    ('three-hundred-sixty-one', 'five-hundred-twenty-seven'),
    ('driehonderdeenenzestig', 'vijfhonderdzevenentwintig'),
    ('all_cases[:356]', 'all_cases[:512]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:512]'),
    ('!= 356', '!= 512'),
