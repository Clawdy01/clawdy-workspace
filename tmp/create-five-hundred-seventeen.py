...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-seventeen'),
    ('driehonderdnegenenzestig', 'vijfhonderdzeventien'),
    ('all_cases[:364]', 'all_cases[:502]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:502]'),
    ('!= 364', '!= 502'),
