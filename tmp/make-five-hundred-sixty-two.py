...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-sixty-two'),
    ('driehonderdvierentachtig', 'vijfhonderdtweeënzestig'),
    ('all_cases[:379]', 'all_cases[:547]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:547]'),
    ('!= 379', '!= 547'),
