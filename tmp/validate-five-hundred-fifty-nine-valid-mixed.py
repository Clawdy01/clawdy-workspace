...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:544]
if len(valid_cases) != 544:
    raise SystemExit(f'kon geen vijfhonderdnegenenvijftig geldige casenamen vinden, kreeg {valid_cases}')
