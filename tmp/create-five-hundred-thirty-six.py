...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-thirty-six'),
    ('driehonderdnegenenzestig', 'vijfhonderdzesendertig'),
    ('all_cases[:364]', 'all_cases[:521]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:521]'),
    ('!= 364', '!= 521'),
