...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-thirty-one'),
    ('driehonderdvierentachtig', 'zeshonderdeenendertig'),
    ('all_cases[:379]', 'all_cases[:616]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:616]'),
    ('!= 379', '!= 616'),
