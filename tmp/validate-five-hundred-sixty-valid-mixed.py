...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:545]
if len(valid_cases) != 545:
    raise SystemExit(f'kon geen vijfhonderdzestig geldige casenamen vinden, kreeg {valid_cases}')
