...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-thirty-seven'),
    ('driehonderdnegenenzestig', 'vijfhonderdzevenendertig'),
    ('all_cases[:364]', 'all_cases[:522]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:522]'),
    ('!= 364', '!= 522'),
