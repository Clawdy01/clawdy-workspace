...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-twenty-eight'),
    ('driehonderdvierentachtig', 'vierhonderdachtentwintig'),
    ('all_cases[:379]', 'all_cases[:413]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:413]'),
    ('!= 379', '!= 413'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-twenty-eight')).write_text(text)
