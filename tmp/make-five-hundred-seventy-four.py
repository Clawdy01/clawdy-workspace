...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-seventy-four'),
    ('driehonderdvierentachtig', 'vijfhonderdvierenzeventig'),
    ('all_cases[:379]', 'all_cases[:559]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:559]'),
    ('!= 379', '!= 559'),
