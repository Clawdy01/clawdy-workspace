...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-thirty-eight'),
    ('driehonderdvierentachtig', 'vierhonderdachtendertig'),
    ('all_cases[:379]', 'all_cases[:423]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:423]'),
    ('!= 379', '!= 423'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-thirty-eight')).write_text(text)
