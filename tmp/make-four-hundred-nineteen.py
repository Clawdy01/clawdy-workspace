...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-nineteen'),
    ('driehonderdvierentachtig', 'vierhonderdnegentien'),
    ('all_cases[:379]', 'all_cases[:404]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:404]'),
    ('!= 379', '!= 404'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-nineteen')).write_text(text)
