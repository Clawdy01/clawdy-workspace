...
repls = [
    ('four-hundred-sixty-three', 'four-hundred-sixty-eight'),
    ('vierhonderddrieënzestig', 'vierhonderdachtenzestig'),
    ('[:448]', '[:453]'),
    ('!= 448', '!= 453'),
    ('kreeg 448', 'kreeg 453'),
]
for name in files:
    ...
    (root / name.replace('four-hundred-sixty-three', 'four-hundred-sixty-eight')).write_text(text)
print('created')
