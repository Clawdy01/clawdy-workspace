...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-twenty-nine'),
    ('driehonderdvierentachtig', 'zeshonderdnegenentwintig'),
    ('all_cases[:379]', 'all_cases[:614]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:614]'),
    ('!= 379', '!= 614'),
