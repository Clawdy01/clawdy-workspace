...
repls = [
    ('three-hundred-sixty-one', 'four-hundred-one'),
    ('driehonderdeenenzestig', 'vierhonderdeen'),
    ('all_cases[:356]', 'all_cases[:396]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:396]'),
    ('!= 356', '!= 396'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-four-hundred-one-{kind}.py'
    text = src.read_text()
