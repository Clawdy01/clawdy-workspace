...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-fifty-three'),
    ('tweehonderdnegenentwintig', 'driehonderddrieënvijftig'),
    ('[:227]', '[:349]'),
    ('!= 227', '!= 349'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-fifty-three-{kind}.py'
    text = src.read_text()
