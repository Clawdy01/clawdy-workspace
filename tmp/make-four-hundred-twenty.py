...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-twenty'),
    ('driehonderdvierentachtig', 'vierhonderdtwintig'),
    ('all_cases[:379]', 'all_cases[:405]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:405]'),
    ('!= 379', '!= 405'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-twenty')).write_text(text)
