...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-thirty-five'),
    ('driehonderdnegenenzestig', 'vijfhonderdvijfendertig'),
    ('all_cases[:364]', 'all_cases[:520]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:520]'),
    ('!= 364', '!= 520'),
