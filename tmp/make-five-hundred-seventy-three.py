...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-seventy-three'),
    ('driehonderdvierentachtig', 'vijfhonderddrieënzeventig'),
    ('all_cases[:379]', 'all_cases[:558]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:558]'),
    ('!= 379', '!= 558'),
