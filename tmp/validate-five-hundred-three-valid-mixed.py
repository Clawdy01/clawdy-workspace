...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:488]
if len(valid_cases) != 488:
    raise SystemExit(f'kon geen vijfhonderddrie geldige casenamen vinden, kreeg {valid_cases}')
