...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-nineteen'),
    ('driehonderdnegenenzestig', 'vijfhonderdnegentien'),
    ('all_cases[:364]', 'all_cases[:504]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:504]'),
    ('!= 364', '!= 504'),
