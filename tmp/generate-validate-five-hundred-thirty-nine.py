...
repls = [
    ('three-hundred-sixty-one', 'five-hundred-thirty-nine'),
    ('driehonderdeenenzestig', 'vijfhonderdnegenendertig'),
    ('all_cases[:356]', 'all_cases[:524]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:524]'),
    ('!= 356', '!= 524'),
