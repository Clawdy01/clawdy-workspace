...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-two'),
    ('driehonderdvierentachtig', 'vierhonderdtwee'),
    ('all_cases[:379]', 'all_cases[:397]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:397]'),
    ('!= 379', '!= 397'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-two')).write_text(text)
