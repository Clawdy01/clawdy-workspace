...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-seventy'),
    ('driehonderdvierentachtig', 'vijfhonderdzeventig'),
    ('all_cases[:379]', 'all_cases[:555]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:555]'),
    ('!= 379', '!= 555'),
