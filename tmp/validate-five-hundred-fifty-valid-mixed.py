...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:535]
if len(valid_cases) != 535:
    raise SystemExit(f'kon geen vijfhonderdvijftig geldige casenamen vinden, kreeg {valid_cases}')
