...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-sixty'),
    ('driehonderdvierentachtig', 'vierhonderdzestig'),
    ('all_cases[:379]', 'all_cases[:445]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:445]'),
    ('!= 379', '!= 445'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-sixty')).write_text(text)
