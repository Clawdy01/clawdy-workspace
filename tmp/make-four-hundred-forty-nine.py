...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-forty-nine'),
    ('driehonderdvierentachtig', 'vierhonderdnegenenveertig'),
    ('all_cases[:379]', 'all_cases[:434]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:434]'),
    ('!= 379', '!= 434'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-forty-nine')).write_text(text)
