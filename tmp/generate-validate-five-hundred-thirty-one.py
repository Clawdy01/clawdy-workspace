...
repls = [
    ('three-hundred-sixty-one', 'five-hundred-thirty-one'),
    ('driehonderdeenenzestig', 'vijfhonderdeenendertig'),
    ('all_cases[:356]', 'all_cases[:516]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:516]'),
    ('!= 356', '!= 516'),
