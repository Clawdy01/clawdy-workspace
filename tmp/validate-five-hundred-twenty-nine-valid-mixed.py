...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:514]
if len(valid_cases) != 514:
    raise SystemExit(f'kon geen vijfhonderdnegenentwintig geldige casenamen vinden, kreeg {valid_cases}')
