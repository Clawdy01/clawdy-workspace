...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-fifty-five'),
    ('driehonderdvierentachtig', 'vijfhonderdvijfenvijftig'),
    ('all_cases[:379]', 'all_cases[:540]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:540]'),
    ('!= 379', '!= 540'),
