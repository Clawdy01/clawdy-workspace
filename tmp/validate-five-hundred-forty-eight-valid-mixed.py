...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:533]
if len(valid_cases) != 533:
    raise SystemExit(f'kon geen vijfhonderdachtenveertig geldige casenamen vinden, kreeg {valid_cases}')
