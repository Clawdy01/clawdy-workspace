...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-twenty-one'),
    ('driehonderdvierentachtig', 'vierhonderdeenentwintig'),
    ('all_cases[:379]', 'all_cases[:406]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:406]'),
    ('!= 379', '!= 406'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-twenty-one')).write_text(text)
