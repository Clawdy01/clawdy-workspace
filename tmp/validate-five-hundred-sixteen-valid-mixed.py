...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:501]
if len(valid_cases) != 501:
    raise SystemExit(f'kon geen vijfhonderdzestien geldige casenamen vinden, kreeg {valid_cases}')
