...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:487]
if len(valid_cases) != 487:
    raise SystemExit(f'kon geen vijfhonderdtwee geldige casenamen vinden, kreeg {valid_cases}')
