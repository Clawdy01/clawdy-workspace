...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-sixty-three'),
    ('driehonderdvierentachtig', 'vierhonderddrieënzestig'),
    ('all_cases[:379]', 'all_cases[:448]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:448]'),
    ('!= 379', '!= 448'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-sixty-three')).write_text(text)
