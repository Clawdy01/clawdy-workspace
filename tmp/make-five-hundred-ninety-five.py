...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-ninety-five'),
    ('driehonderdvierentachtig', 'vijfhonderdvijfennegentig'),
    ('all_cases[:379]', 'all_cases[:580]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:580]'),
    ('!= 379', '!= 580'),
