...
repls = [
    ('three-hundred-sixty-one', 'four-hundred-eighteen'),
    ('driehonderdeenenzestig', 'vierhonderdachttien'),
    ('all_cases[:356]', 'all_cases[:403]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:403]'),
    ('!= 356', '!= 403'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-four-hundred-eighteen-{kind}.py'
    text = src.read_text()
