...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-ninety-two'),
    ('driehonderdvierentachtig', 'vijfhonderdtweeënnegentig'),
    ('all_cases[:379]', 'all_cases[:577]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:577]'),
    ('!= 379', '!= 577'),
