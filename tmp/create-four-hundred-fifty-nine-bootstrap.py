...
repls = [
    ...
    ('vierhonderdachtenvijftig', 'vierhonderdnegenenvijftig'),
    ('all_cases[:443]', 'all_cases[:444]'),
    ('{UNKNOWN, TYPO}][:443]', '{UNKNOWN, TYPO}][:444]'),
    ('!= 443', '!= 444'),
    ('kreeg 443', 'kreeg 444'),
    (', 430, 431, 432, 433, 434, 435, 436, 437, 438, 439, 440, 441, 442]', ', 430, 431, 432, 433, 434, 435, 436, 437, 438, 439, 440, 441, 442, 443]'),
]
for src_name in [
    ...
    src = root / src_name
    dst = root / src_name.replace('four-hundred-fifty-eight', 'four-hundred-fifty-nine')
    text = src.read_text()
