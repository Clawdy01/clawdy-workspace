...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:529]
if len(valid_cases) != 529:
    raise SystemExit(f'kon geen vijfhonderdvierenveertig geldige casenamen vinden, kreeg {valid_cases}')
