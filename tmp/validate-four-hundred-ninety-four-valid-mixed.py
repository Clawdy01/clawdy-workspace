...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:479]
if len(valid_cases) != 479:
    raise SystemExit(f'kon geen vierhonderdvierennegentig geldige casenamen vinden, kreeg {valid_cases}')
