...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:483]
if len(valid_cases) != 483:
    raise SystemExit(f'kon geen vierhonderdachtennegentig geldige casenamen vinden, kreeg {valid_cases}')
