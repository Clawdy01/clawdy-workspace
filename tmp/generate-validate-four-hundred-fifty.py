...
repls = [
    ('three-hundred-sixty-one', 'four-hundred-fifty'),
    ('driehonderdeenenzestig', 'vierhonderdvijftig'),
    ('all_cases[:356]', 'all_cases[:435]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:435]'),
    ('!= 356', '!= 435'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-four-hundred-fifty-{kind}.py'
    text = src.read_text()
