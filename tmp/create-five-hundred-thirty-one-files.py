...
repls = [
    ('three-hundred-seventy-four', 'five-hundred-thirty-one'),
    ('driehonderdvierenzeventig', 'vijfhonderdeenendertig'),
    ('all_cases[:369]', 'all_cases[:516]'),
    ('{UNKNOWN, TYPO}][:369]', '{UNKNOWN, TYPO}][:516]'),
    ('!= 369', '!= 516'),
