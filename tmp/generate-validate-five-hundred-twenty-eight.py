...
repls = [
    ('three-hundred-sixty-one', 'five-hundred-twenty-eight'),
    ('driehonderdeenenzestig', 'vijfhonderdachtentwintig'),
    ('all_cases[:356]', 'all_cases[:513]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:513]'),
    ('!= 356', '!= 513'),
