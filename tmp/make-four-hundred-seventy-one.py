...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-seventy-one'),
    ('driehonderdvierentachtig', 'vierhonderdeenenzeventig'),
    ('all_cases[:379]', 'all_cases[:456]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:456]'),
    ('!= 379', '!= 456'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-seventy-one')).write_text(text)
