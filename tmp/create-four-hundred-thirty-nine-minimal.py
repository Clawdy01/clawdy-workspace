...
repls = [
    ('four-hundred-thirty-four', 'four-hundred-thirty-nine'),
    ('vierhonderdvierendertig', 'vierhonderdnegenendertig'),
    ('[:423]', '[:423]'),
    ('!= 422', '!= 424'),
    ('kreeg 422', 'kreeg 424'),
    (' 419)', ' 420)'),
    (', 413, 414, 415, 416, 417, 418]', ', 413, 414, 415, 416, 417, 418, 419, 420, 421, 422, 423]'),
]
for name in files:
    text = (root / name).read_text()
    for old, new in repls:
        text = text.replace(old, new)
    (root / name.replace('four-hundred-thirty-four', 'four-hundred-thirty-nine')).write_text(text)
