...
repls = [
    ('three-hundred-eighty-seven', 'three-hundred-ninety-one'),
    ('driehonderdzevenentachtig', 'driehonderdeenennegentig'),
    ('all_cases[:382]', 'all_cases[:386]'),
    ('{UNKNOWN, TYPO}][:382]', '{UNKNOWN, TYPO}][:386]'),
    ('!= 382', '!= 386'),
...
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'three-hundred-ninety-one')).write_text(text)
