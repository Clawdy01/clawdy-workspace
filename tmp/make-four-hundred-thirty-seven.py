...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-thirty-seven'),
    ('driehonderdvierentachtig', 'vierhonderdzevenendertig'),
    ('all_cases[:379]', 'all_cases[:422]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:422]'),
    ('!= 379', '!= 422'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-thirty-seven')).write_text(text)
