...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-forty-one'),
    ('driehonderdvierentachtig', 'vijfhonderdeenenveertig'),
    ('all_cases[:379]', 'all_cases[:526]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:526]'),
    ('!= 379', '!= 526'),
