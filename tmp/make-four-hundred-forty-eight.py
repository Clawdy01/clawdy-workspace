...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-forty-eight'),
    ('driehonderdvierentachtig', 'vierhonderdachtenveertig'),
    ('all_cases[:379]', 'all_cases[:433]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:433]'),
    ('!= 379', '!= 433'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-forty-eight')).write_text(text)
