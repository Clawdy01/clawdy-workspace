...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-thirty-two'),
    ('driehonderdnegenenzestig', 'vijfhonderdtweeëndertig'),
    ('all_cases[:364]', 'all_cases[:517]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:517]'),
    ('!= 364', '!= 517'),
