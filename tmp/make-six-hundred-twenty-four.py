...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-twenty-four'),
    ('driehonderdvierentachtig', 'zeshonderdvierentwintig'),
    ('all_cases[:379]', 'all_cases[:609]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:609]'),
    ('!= 379', '!= 609'),
