...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:516]
if len(valid_cases) != 516:
    raise SystemExit(f'kon geen vijfhonderdeenendertig geldige casenamen vinden, kreeg {valid_cases}')
