...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:493]
if len(valid_cases) != 493:
    raise SystemExit(f'kon geen vijfhonderdacht geldige casenamen vinden, kreeg {valid_cases}')
