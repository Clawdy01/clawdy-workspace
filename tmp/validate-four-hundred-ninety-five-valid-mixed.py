...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:480]
if len(valid_cases) != 480:
    raise SystemExit(f'kon geen vierhonderdvijfennegentig geldige casenamen vinden, kreeg {valid_cases}')
