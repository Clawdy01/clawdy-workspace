...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-sixty-three'),
    ('driehonderdvierentachtig', 'vijfhonderddrieënzestig'),
    ('all_cases[:379]', 'all_cases[:548]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:548]'),
    ('!= 379', '!= 548'),
