...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:503]
if len(valid_cases) != 503:
    raise SystemExit(f'kon geen vijfhonderdachttien geldige casenamen vinden, kreeg {valid_cases}')
