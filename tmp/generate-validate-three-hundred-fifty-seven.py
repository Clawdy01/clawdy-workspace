...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-fifty-seven'),
    ('tweehonderdnegenentwintig', 'driehonderdzevenenvijftig'),
    ('[:227]', '[:353]'),
    ('!= 227', '!= 353'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-fifty-seven-{kind}.py'
    text = src.read_text()
