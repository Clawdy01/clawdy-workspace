...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-thirty-five'),
    ('driehonderdvierentachtig', 'zeshonderdvijfendertig'),
    ('all_cases[:379]', 'all_cases[:620]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:620]'),
    ('!= 379', '!= 620'),
