...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-fifty-two'),
    ('tweehonderdnegenentwintig', 'driehonderdtweeënvijftig'),
    ('[:227]', '[:348]'),
    ('!= 227', '!= 348'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-fifty-two-{kind}.py'
    text = src.read_text()
