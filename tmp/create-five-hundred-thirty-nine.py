...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-thirty-nine'),
    ('driehonderdnegenenzestig', 'vijfhonderdnegenendertig'),
    ('all_cases[:364]', 'all_cases[:524]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:524]'),
    ('!= 364', '!= 524'),
