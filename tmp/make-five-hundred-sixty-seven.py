...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-sixty-seven'),
    ('driehonderdvierentachtig', 'vijfhonderdzevenenzestig'),
    ('all_cases[:379]', 'all_cases[:552]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:552]'),
    ('!= 379', '!= 552'),
