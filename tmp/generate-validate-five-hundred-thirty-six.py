...
repls = [
    ('three-hundred-sixty-one', 'five-hundred-thirty-six'),
    ('driehonderdeenenzestig', 'vijfhonderdzesendertig'),
    ('all_cases[:356]', 'all_cases[:521]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:521]'),
    ('!= 356', '!= 521'),
