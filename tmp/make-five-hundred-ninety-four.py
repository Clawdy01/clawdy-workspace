...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-ninety-four'),
    ('driehonderdvierentachtig', 'vijfhonderdvierennegentig'),
    ('all_cases[:379]', 'all_cases[:579]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:579]'),
    ('!= 379', '!= 579'),
