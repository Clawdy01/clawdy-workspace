...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-seventy'),
    ('driehonderdvierentachtig', 'vierhonderdzeventig'),
    ('all_cases[:379]', 'all_cases[:455]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:455]'),
    ('!= 379', '!= 455'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-seventy')).write_text(text)
