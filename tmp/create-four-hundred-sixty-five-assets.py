...
repls = [
    ('four-hundred-sixty-three', 'four-hundred-sixty-five'),
    ('vierhonderddrieënzestig', 'vierhonderdvijfenzestig'),
    ('[:448]', '[:450]'),
    ('!= 448', '!= 450'),
    ('kreeg 448', 'kreeg 450'),
]
for name in files:
    ...
    (root / name.replace('four-hundred-sixty-three', 'four-hundred-sixty-five')).write_text(text)
print('created')
