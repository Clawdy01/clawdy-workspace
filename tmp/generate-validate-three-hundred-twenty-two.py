...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-twenty-two'),
    ('tweehonderdnegenentwintig', 'driehonderdtweeentwintig'),
    ('[:227]', '[:318]'),
    ('!= 227', '!= 318'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-twenty-two-{kind}.py'
    text = src.read_text()
