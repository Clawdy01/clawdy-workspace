...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-forty-four'),
    ('driehonderdvierentachtig', 'vierhonderdvierenveertig'),
    ('all_cases[:379]', 'all_cases[:429]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:429]'),
    ('!= 379', '!= 429'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-forty-four')).write_text(text)
