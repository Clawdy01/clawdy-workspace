...
repls = [
    ('three-hundred-eighty-seven', 'four-hundred'),
    ('driehonderdzevenentachtig', 'vierhonderd'),
    ('all_cases[:382]', 'all_cases[:395]'),
    ('{UNKNOWN, TYPO}][:382]', '{UNKNOWN, TYPO}][:395]'),
    ('!= 382', '!= 395'),
...
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'four-hundred')).write_text(text)
