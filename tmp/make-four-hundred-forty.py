...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-forty'),
    ('driehonderdvierentachtig', 'vierhonderdveertig'),
    ('all_cases[:379]', 'all_cases[:425]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:425]'),
    ('!= 379', '!= 425'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-forty')).write_text(text)
