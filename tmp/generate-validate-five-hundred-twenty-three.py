...
repls = [
    ('three-hundred-sixty-one', 'five-hundred-twenty-three'),
    ('driehonderdeenenzestig', 'vijfhonderddrieëntwintig'),
    ('all_cases[:356]', 'all_cases[:508]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:508]'),
    ('!= 356', '!= 508'),
