...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-twenty-one'),
    ('driehonderdnegenenzestig', 'vijfhonderdeenentwintig'),
    ('all_cases[:364]', 'all_cases[:506]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:506]'),
    ('!= 364', '!= 506'),
