...
repls = [
    ('three-hundred-eighty-seven', 'three-hundred-ninety-five'),
    ('driehonderdzevenentachtig', 'driehonderdvijfennegentig'),
    ('all_cases[:382]', 'all_cases[:390]'),
    ('{UNKNOWN, TYPO}][:382]', '{UNKNOWN, TYPO}][:390]'),
    ('!= 382', '!= 390'),
...
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'three-hundred-ninety-five')).write_text(text)
