...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:530]
if len(valid_cases) != 530:
    raise SystemExit(f'kon geen vijfhonderdvijfenveertig geldige casenamen vinden, kreeg {valid_cases}')
