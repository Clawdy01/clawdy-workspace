...
repls = [
    ('three-hundred-seventy-four', 'five-hundred-thirty-three'),
    ('driehonderdvierenzeventig', 'vijfhonderddrieëndertig'),
    ('all_cases[:369]', 'all_cases[:518]'),
    ('{UNKNOWN, TYPO}][:369]', '{UNKNOWN, TYPO}][:518]'),
    ('!= 369', '!= 518'),
