...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:505]
if len(valid_cases) != 505:
    raise SystemExit(f'kon geen vijfhonderdtwintig geldige casenamen vinden, kreeg {valid_cases}')
