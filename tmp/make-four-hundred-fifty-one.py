...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-fifty-one'),
    ('driehonderdvierentachtig', 'vierhonderdeenenvijftig'),
    ('all_cases[:379]', 'all_cases[:436]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:436]'),
    ('!= 379', '!= 436'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-fifty-one')).write_text(text)
