...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-sixty-four'),
    ('driehonderdvierentachtig', 'vierhonderdvierenzestig'),
    ('all_cases[:379]', 'all_cases[:449]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:449]'),
    ('!= 379', '!= 449'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-sixty-four')).write_text(text)
