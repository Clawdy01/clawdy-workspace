...
repls = [
    ('four-hundred-thirty-four', 'four-hundred-thirty-six'),
    ('vierhonderdvierendertig', 'vierhonderdzesendertig'),
    ('[:420]', '[:421]'),
    ('!= 420', '!= 421'),
    ('kreeg 420', 'kreeg 421'),
    (' 419)', ' 420)'),
    (', 413, 414, 415, 416, 417, 418]', ', 413, 414, 415, 416, 417, 418, 419, 420]'),
]
for name in files:
    text = (root / name).read_text()
    for old, new in repls:
        text = text.replace(old, new)
    (root / name.replace('four-hundred-thirty-four', 'four-hundred-thirty-six')).write_text(text)
