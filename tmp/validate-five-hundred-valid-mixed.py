...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:485]
if len(valid_cases) != 485:
    raise SystemExit(f'kon geen vijfhonderd geldige casenamen vinden, kreeg {valid_cases}')
