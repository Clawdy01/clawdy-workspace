...
repls = [
    ('three-hundred-sixty-one', 'four-hundred-three'),
    ('driehonderdeenenzestig', 'vierhonderddrie'),
    ('all_cases[:356]', 'all_cases[:398]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:398]'),
    ('!= 356', '!= 398'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-four-hundred-three-{kind}.py'
    text = src.read_text()
