...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:498]
if len(valid_cases) != 498:
    raise SystemExit(f'kon geen vijfhonderddertien geldige casenamen vinden, kreeg {valid_cases}')
