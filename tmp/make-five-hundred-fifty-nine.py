...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-fifty-nine'),
    ('driehonderdvierentachtig', 'vijfhonderdnegenenvijftig'),
    ('all_cases[:379]', 'all_cases[:544]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:544]'),
    ('!= 379', '!= 544'),
