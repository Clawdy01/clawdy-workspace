...
repls = [
    ('three-hundred-sixty-one', 'four-hundred-thirty'),
    ('driehonderdeenenzestig', 'vierhonderddertig'),
    ('all_cases[:356]', 'all_cases[:415]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:415]'),
    ('!= 356', '!= 415'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-four-hundred-thirty-{kind}.py'
    text = src.read_text()
