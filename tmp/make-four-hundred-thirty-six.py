...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-thirty-six'),
    ('driehonderdvierentachtig', 'vierhonderdzesendertig'),
    ('all_cases[:379]', 'all_cases[:421]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:421]'),
    ('!= 379', '!= 421'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-thirty-six')).write_text(text)
