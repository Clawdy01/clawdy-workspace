...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:547]
if len(valid_cases) != 547:
    raise SystemExit(f'kon geen vijfhonderdtweeënzestig geldige casenamen vinden, kreeg {valid_cases}')
