...
if len(valid_cases) != 257:
    raise SystemExit(f'kon geen tweehonderdeenenzestig geldige casenamen vinden, kreeg {valid_cases}')
...
if expected_stderr not in (plain_proc.stderr or ''):
    raise SystemExit('plain stderr noemt niet alle tweehonderdeenenzestig geldige first-seen cases')
