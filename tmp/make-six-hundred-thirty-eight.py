...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-thirty-eight'),
    ('driehonderdvierentachtig', 'zeshonderdachtendertig'),
    ('all_cases[:379]', 'all_cases[:623]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:623]'),
    ('!= 379', '!= 623'),
