...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-fifty-one'),
    ('driehonderdvierentachtig', 'zeshonderdeenenvijftig'),
    ('all_cases[:379]', 'all_cases[:636]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:636]'),
    ('!= 379', '!= 636'),
