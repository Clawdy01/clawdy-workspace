...
if len(valid_cases) != 355:
    raise SystemExit(f'kon geen driehonderdzestig geldige casenamen vinden, kreeg {valid_cases}')
...
if expected_stderr not in (plain_proc.stderr or ''):
    raise SystemExit('plain stderr noemt niet alle driehonderdzestig geldige first-seen cases')
