...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-eighty-nine'),
    ('driehonderdvierentachtig', 'vijfhonderdnegenentachtig'),
    ('all_cases[:379]', 'all_cases[:574]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:574]'),
    ('!= 379', '!= 574'),
