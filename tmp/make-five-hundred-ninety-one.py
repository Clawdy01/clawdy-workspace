...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-ninety-one'),
    ('driehonderdvierentachtig', 'vijfhonderdeenennegentig'),
    ('all_cases[:379]', 'all_cases[:576]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:576]'),
    ('!= 379', '!= 576'),
