...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-thirty-eight'),
    ('tweehonderdnegenentwintig', 'driehonderdachtendertig'),
    ('[:227]', '[:334]'),
    ('!= 227', '!= 334'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-thirty-eight-{kind}.py'
    text = src.read_text()
