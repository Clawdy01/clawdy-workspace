...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-sixty-eight'),
    ('driehonderdvierentachtig', 'vijfhonderdachtenzestig'),
    ('all_cases[:379]', 'all_cases[:553]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:553]'),
    ('!= 379', '!= 553'),
