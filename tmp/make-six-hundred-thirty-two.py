...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-thirty-two'),
    ('driehonderdvierentachtig', 'zeshonderdtweeëndertig'),
    ('all_cases[:379]', 'all_cases[:617]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:617]'),
    ('!= 379', '!= 617'),
