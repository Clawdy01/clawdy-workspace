...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:502]
if len(valid_cases) != 502:
    raise SystemExit(f'kon geen vijfhonderdzeventien geldige casenamen vinden, kreeg {valid_cases}')
