...
repls = [
    ('three-hundred-sixty-one', 'five-hundred-twenty-one'),
    ('driehonderdeenenzestig', 'vijfhonderdeenentwintig'),
    ('all_cases[:356]', 'all_cases[:506]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:506]'),
    ('!= 356', '!= 506'),
