...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-ninety-nine'),
    ('driehonderdvierentachtig', 'vijfhonderdnegenennegentig'),
    ('all_cases[:379]', 'all_cases[:584]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:584]'),
    ('!= 379', '!= 584'),
