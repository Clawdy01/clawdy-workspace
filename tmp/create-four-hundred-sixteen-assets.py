...
repls = [
    ('three-hundred-eighty-seven', 'four-hundred-sixteen'),
    ('driehonderdzevenentachtig', 'vierhonderdzestien'),
...
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'four-hundred-sixteen')).write_text(text)
