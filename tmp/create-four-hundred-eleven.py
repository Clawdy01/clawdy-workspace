...
repls = [
    ('three-hundred-sixty-nine', 'four-hundred-eleven'),
    ('driehonderdnegenenzestig', 'vierhonderdelf'),
...
for name in (
    ...
    src = root / 'tmp' / name
    dst = root / 'tmp' / name.replace('three-hundred-sixty-nine', 'four-hundred-eleven')
    text = src.read_text()
