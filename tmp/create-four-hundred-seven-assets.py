...
repls = [
    ('three-hundred-eighty-seven', 'four-hundred-seven'),
    ('driehonderdzevenentachtig', 'vierhonderdzeven'),
...
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'four-hundred-seven')).write_text(text)
