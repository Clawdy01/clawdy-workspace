...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:550]
if len(valid_cases) != 550:
    raise SystemExit(f'kon geen vijfhonderdvijfenzestig geldige casenamen vinden, kreeg {valid_cases}')
