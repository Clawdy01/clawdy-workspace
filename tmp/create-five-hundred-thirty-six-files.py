...
repls = [
    ('three-hundred-seventy-four', 'five-hundred-thirty-six'),
    ('driehonderdvierenzeventig', 'vijfhonderdzesendertig'),
    ('all_cases[:369]', 'all_cases[:521]'),
    ('{UNKNOWN, TYPO}][:369]', '{UNKNOWN, TYPO}][:521]'),
    ('!= 369', '!= 521'),
