...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-fifty-seven'),
    ('driehonderdvierentachtig', 'vijfhonderdzevenenvijftig'),
    ('all_cases[:379]', 'all_cases[:542]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:542]'),
    ('!= 379', '!= 542'),
