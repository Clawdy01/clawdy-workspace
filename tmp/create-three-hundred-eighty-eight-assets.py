...
repls = [
    ('three-hundred-eighty-seven', 'three-hundred-eighty-eight'),
    ('driehonderdzevenentachtig', 'driehonderdachtentachtig'),
    ('all_cases[:382]', 'all_cases[:383]'),
    ('{UNKNOWN, TYPO}][:382]', '{UNKNOWN, TYPO}][:383]'),
    ('!= 382', '!= 383'),
    ('381]', '381, 382]'),
]
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'three-hundred-eighty-eight')).write_text(text)
