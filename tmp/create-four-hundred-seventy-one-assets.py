...
repls = [
    ('four-hundred-sixty-three', 'four-hundred-seventy-one'),
    ('vierhonderddrieënzestig', 'vierhonderdeenenzeventig'),
    ('[:448]', '[:456]'),
    ('!= 448', '!= 456'),
    ('kreeg 448', 'kreeg 456'),
]
for name in files:
    ...
    (root / name.replace('four-hundred-sixty-three', 'four-hundred-seventy-one')).write_text(text)
print('created')
