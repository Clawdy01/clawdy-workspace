...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:549]
if len(valid_cases) != 549:
    raise SystemExit(f'kon geen vijfhonderdvierenzestig geldige casenamen vinden, kreeg {valid_cases}')
