...
repls = [
    ('three-hundred-eighty-four', 'three-hundred-ninety-five'),
    ('driehonderdvierentachtig', 'driehonderdvijfennegentig'),
    ('all_cases[:379]', 'all_cases[:390]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:390]'),
    ('!= 379', '!= 390'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'three-hundred-ninety-five')).write_text(text)
