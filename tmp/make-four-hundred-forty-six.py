...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-forty-six'),
    ('driehonderdvierentachtig', 'vierhonderdzesenveertig'),
    ('all_cases[:379]', 'all_cases[:431]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:431]'),
    ('!= 379', '!= 431'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-forty-six')).write_text(text)
