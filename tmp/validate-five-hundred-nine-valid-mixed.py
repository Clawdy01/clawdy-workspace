...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:494]
if len(valid_cases) != 494:
    raise SystemExit(f'kon geen vijfhonderdnegen geldige casenamen vinden, kreeg {valid_cases}')
