...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:496]
if len(valid_cases) != 496:
    raise SystemExit(f'kon geen vijfhonderdelf geldige casenamen vinden, kreeg {valid_cases}')
