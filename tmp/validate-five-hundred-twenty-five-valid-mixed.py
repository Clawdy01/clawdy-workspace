...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:510]
if len(valid_cases) != 510:
    raise SystemExit(f'kon geen vijfhonderdvijfentwintig geldige casenamen vinden, kreeg {valid_cases}')
