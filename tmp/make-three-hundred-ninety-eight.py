...
repls = [
    ('three-hundred-eighty-four', 'three-hundred-ninety-eight'),
    ('driehonderdvierentachtig', 'driehonderdachtennegentig'),
    ('all_cases[:379]', 'all_cases[:393]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:393]'),
    ('!= 379', '!= 393'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'three-hundred-ninety-eight')).write_text(text)
