...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-fifty-six'),
    ('driehonderdvierentachtig', 'vijfhonderdzesenvijftig'),
    ('all_cases[:379]', 'all_cases[:541]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:541]'),
    ('!= 379', '!= 541'),
