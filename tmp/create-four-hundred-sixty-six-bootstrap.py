...
repls = [
    ('four-hundred-fifty-eight', 'four-hundred-sixty-six'),
    ('vierhonderdachtenvijftig', 'vierhonderdzesenzestig'),
    ('all_cases[:443]', 'all_cases[:451]'),
    ('{UNKNOWN, TYPO}][:443]', '{UNKNOWN, TYPO}][:451]'),
    ('!= 443', '!= 451'),
    ('kreeg 443', 'kreeg 451'),
...
for src_name in [
    ...
    src = root / src_name
    dst = root / src_name.replace('four-hundred-fifty-eight', 'four-hundred-sixty-six')
    text = src.read_text()
