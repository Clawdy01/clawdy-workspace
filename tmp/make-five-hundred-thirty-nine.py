...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-thirty-nine'),
    ('driehonderdvierentachtig', 'vijfhonderdnegenendertig'),
    ('all_cases[:379]', 'all_cases[:524]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:524]'),
    ('!= 379', '!= 524'),
