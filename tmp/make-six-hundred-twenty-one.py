...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-twenty-one'),
    ('driehonderdvierentachtig', 'zeshonderdeenentwintig'),
    ('all_cases[:379]', 'all_cases[:606]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:606]'),
    ('!= 379', '!= 606'),
