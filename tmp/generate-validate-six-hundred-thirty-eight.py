...
repls = [
    ('three-hundred-sixty-one', 'six-hundred-thirty-eight'),
    ('driehonderdeenenzestig', 'zeshonderdachtendertig'),
    ('all_cases[:356]', 'all_cases[:623]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:623]'),
    ('!= 356', '!= 623'),
