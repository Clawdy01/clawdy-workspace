...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-thirty-two'),
    ('driehonderdvierentachtig', 'vijfhonderdtweeëndertig'),
    ('all_cases[:379]', 'all_cases[:517]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:517]'),
    ('!= 379', '!= 517'),
