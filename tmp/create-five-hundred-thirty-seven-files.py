...
repls = [
    ('three-hundred-seventy-four', 'five-hundred-thirty-seven'),
    ('driehonderdvierenzeventig', 'vijfhonderdzevenendertig'),
    ('all_cases[:369]', 'all_cases[:522]'),
    ('{UNKNOWN, TYPO}][:369]', '{UNKNOWN, TYPO}][:522]'),
    ('!= 369', '!= 522'),
