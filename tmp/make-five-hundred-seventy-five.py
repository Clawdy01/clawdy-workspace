...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-seventy-five'),
    ('driehonderdvierentachtig', 'vijfhonderdvijfenzeventig'),
    ('all_cases[:379]', 'all_cases[:560]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:560]'),
    ('!= 379', '!= 560'),
