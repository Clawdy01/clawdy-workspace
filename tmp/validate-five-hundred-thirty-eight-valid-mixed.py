...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:523]
if len(valid_cases) != 523:
    raise SystemExit(f'kon geen vijfhonderdachtendertig geldige casenamen vinden, kreeg {valid_cases}')
