...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-thirty-nine'),
    ('tweehonderdnegenentwintig', 'driehonderdnegenendertig'),
    ('[:227]', '[:335]'),
    ('!= 227', '!= 335'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-thirty-nine-{kind}.py'
    text = src.read_text()
