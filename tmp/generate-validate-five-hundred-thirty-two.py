...
repls = [
    ('three-hundred-sixty-one', 'five-hundred-thirty-two'),
    ('driehonderdeenenzestig', 'vijfhonderdtweeëndertig'),
    ('all_cases[:356]', 'all_cases[:517]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:517]'),
    ('!= 356', '!= 517'),
