...
repls = [
    ('three-hundred-sixty-one', 'four-hundred-sixty-one'),
    ('driehonderdeenenzestig', 'vierhonderdeenenzestig'),
    ('all_cases[:356]', 'all_cases[:446]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:446]'),
    ('!= 356', '!= 446'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-four-hundred-sixty-one-{kind}.py'
    text = src.read_text()
