...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-forty-seven'),
    ('driehonderdvierentachtig', 'vierhonderdzevenenveertig'),
    ('all_cases[:379]', 'all_cases[:432]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:432]'),
    ('!= 379', '!= 432'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-forty-seven')).write_text(text)
