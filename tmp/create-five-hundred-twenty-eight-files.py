...
repls = [
    ('three-hundred-seventy-four', 'five-hundred-twenty-eight'),
    ('driehonderdvierenzeventig', 'vijfhonderdachtentwintig'),
    ('all_cases[:369]', 'all_cases[:513]'),
    ('{UNKNOWN, TYPO}][:369]', '{UNKNOWN, TYPO}][:513]'),
    ('!= 369', '!= 513'),
