...
repls = [
    ('three-hundred-sixty-one', 'five-hundred-twenty-six'),
    ('driehonderdeenenzestig', 'vijfhonderdzesentwintig'),
    ('all_cases[:356]', 'all_cases[:511]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:511]'),
    ('!= 356', '!= 511'),
