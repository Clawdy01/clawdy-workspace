...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:546]
if len(valid_cases) != 546:
    raise SystemExit(f'kon geen vijfhonderdeenenzestig geldige casenamen vinden, kreeg {valid_cases}')
