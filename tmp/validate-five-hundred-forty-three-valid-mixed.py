...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:528]
if len(valid_cases) != 528:
    raise SystemExit(f'kon geen vijfhonderddrieënveertig geldige casenamen vinden, kreeg {valid_cases}')
