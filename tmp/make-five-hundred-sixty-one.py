...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-sixty-one'),
    ('driehonderdvierentachtig', 'vijfhonderdeenenzestig'),
    ('all_cases[:379]', 'all_cases[:546]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:546]'),
    ('!= 379', '!= 546'),
