...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:504]
if len(valid_cases) != 504:
    raise SystemExit(f'kon geen vijfhonderdnegentien geldige casenamen vinden, kreeg {valid_cases}')
