...
repls = [
    ('three-hundred-sixty-one', 'four-hundred-five'),
    ('driehonderdeenenzestig', 'vierhonderdvijf'),
    ('all_cases[:356]', 'all_cases[:400]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:400]'),
    ('!= 356', '!= 400'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-four-hundred-five-{kind}.py'
    text = src.read_text()
