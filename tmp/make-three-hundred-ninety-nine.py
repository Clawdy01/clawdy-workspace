...
repls = [
    ('three-hundred-eighty-four', 'three-hundred-ninety-nine'),
    ('driehonderdvierentachtig', 'driehonderdnegenennegentig'),
    ('all_cases[:379]', 'all_cases[:394]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:394]'),
    ('!= 379', '!= 394'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'three-hundred-ninety-nine')).write_text(text)
