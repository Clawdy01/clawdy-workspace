...
repls = [
    ('three-hundred-eighty-four', 'four-hundred'),
    ('driehonderdvierentachtig', 'vierhonderd'),
    ('all_cases[:379]', 'all_cases[:395]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:395]'),
    ('!= 379', '!= 395'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred')).write_text(text)
