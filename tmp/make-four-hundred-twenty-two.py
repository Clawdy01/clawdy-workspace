...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-twenty-two'),
    ('driehonderdvierentachtig', 'vierhonderdtweeentwintig'),
    ('all_cases[:379]', 'all_cases[:407]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:407]'),
    ('!= 379', '!= 407'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-twenty-two')).write_text(text)
