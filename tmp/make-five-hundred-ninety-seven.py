...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-ninety-seven'),
    ('driehonderdvierentachtig', 'vijfhonderdzevenennegentig'),
    ('all_cases[:379]', 'all_cases[:582]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:582]'),
    ('!= 379', '!= 582'),
