...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:521]
if len(valid_cases) != 521:
    raise SystemExit(f'kon geen vijfhonderdzesendertig geldige casenamen vinden, kreeg {valid_cases}')
