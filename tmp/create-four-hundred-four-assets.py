...
repls = [
    ('three-hundred-eighty-seven', 'four-hundred-four'),
    ('driehonderdzevenentachtig', 'vierhonderdvier'),
    ('all_cases[:382]', 'all_cases[:399]'),
    ('{UNKNOWN, TYPO}][:382]', '{UNKNOWN, TYPO}][:399]'),
    ('!= 382', '!= 399'),
...
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'four-hundred-four')).write_text(text)
