...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-thirty-three'),
    ('tweehonderdnegenentwintig', 'driehonderddrieëndertig'),
    ('[:227]', '[:329]'),
    ('!= 227', '!= 329'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-thirty-three-{kind}.py'
    text = src.read_text()
