...
repls = [
    ('four-hundred-fifty-eight', 'four-hundred-sixty-nine'),
    ('vierhonderdachtenvijftig', 'vierhonderdnegenenzestig'),
    ('all_cases[:443]', 'all_cases[:454]'),
    ('{UNKNOWN, TYPO}][:443]', '{UNKNOWN, TYPO}][:454]'),
    ('!= 443', '!= 454'),
    ('kreeg 443', 'kreeg 454'),
...
for src_name in [
    ...
    src = root / src_name
    dst = root / src_name.replace('four-hundred-fifty-eight', 'four-hundred-sixty-nine')
    text = src.read_text()
