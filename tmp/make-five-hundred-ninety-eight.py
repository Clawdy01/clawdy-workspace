...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-ninety-eight'),
    ('driehonderdvierentachtig', 'vijfhonderdachtennegentig'),
    ('all_cases[:379]', 'all_cases[:583]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:583]'),
    ('!= 379', '!= 583'),
