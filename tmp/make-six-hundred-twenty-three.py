...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-twenty-three'),
    ('driehonderdvierentachtig', 'zeshonderddrieëntwintig'),
    ('all_cases[:379]', 'all_cases[:608]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:608]'),
    ('!= 379', '!= 608'),
