...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-fifty-one'),
    ('driehonderdvierentachtig', 'vijfhonderdeenenvijftig'),
    ('all_cases[:379]', 'all_cases[:536]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:536]'),
    ('!= 379', '!= 536'),
