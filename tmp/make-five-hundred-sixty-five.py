...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-sixty-five'),
    ('driehonderdvierentachtig', 'vijfhonderdvijfenzestig'),
    ('all_cases[:379]', 'all_cases[:550]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:550]'),
    ('!= 379', '!= 550'),
