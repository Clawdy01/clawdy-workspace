...
repls = [
    ('four-hundred-sixty-three', 'four-hundred-seventy-four'),
    ('vierhonderddrieënzestig', 'vierhonderdvierenzeventig'),
    ('[:448]', '[:459]'),
    ('!= 448', '!= 459'),
    ('kreeg 448', 'kreeg 459'),
]
for name in files:
    ...
    (root / name.replace('four-hundred-sixty-three', 'four-hundred-seventy-four')).write_text(text)
print('created')
