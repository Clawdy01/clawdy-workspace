...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-forty-one'),
    ('driehonderdvierentachtig', 'zeshonderdeenenveertig'),
    ('all_cases[:379]', 'all_cases[:626]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:626]'),
    ('!= 379', '!= 626'),
