...
repls = [
    ('three-hundred-eighty-seven', 'four-hundred-twelve'),
    ('driehonderdzevenentachtig', 'vierhonderdtwaalf'),
...
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'four-hundred-twelve')).write_text(text)
