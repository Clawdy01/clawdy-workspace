...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-seventy-two'),
    ('driehonderdvierentachtig', 'vijfhonderdtweeënzeventig'),
    ('all_cases[:379]', 'all_cases[:557]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:557]'),
    ('!= 379', '!= 557'),
