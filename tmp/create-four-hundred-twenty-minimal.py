...
repls = [
    ('four-hundred-eighteen', 'four-hundred-twenty'),
    ('vierhonderdachttien', 'vierhonderdtwintig'),
    ('[:403]', '[:405]'),
    ('!= 403', '!= 405'),
    ('kreeg 403', 'kreeg 405'),
    (' 403)', ' 405)'),
...
for name in files:
    ...
    (root / name.replace('four-hundred-eighteen', 'four-hundred-twenty')).write_text(text)
