...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-fifty-five'),
    ('driehonderdvierentachtig', 'vierhonderdvijfenvijftig'),
    ('all_cases[:379]', 'all_cases[:440]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:440]'),
    ('!= 379', '!= 440'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-fifty-five')).write_text(text)
