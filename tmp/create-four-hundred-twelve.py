...
repls = [
    ('three-hundred-sixty-nine', 'four-hundred-twelve'),
    ('driehonderdnegenenzestig', 'vierhonderdtwaalf'),
...
for name in (
    ...
    src = root / 'tmp' / name
    dst = root / 'tmp' / name.replace('three-hundred-sixty-nine', 'four-hundred-twelve')
    text = src.read_text()
