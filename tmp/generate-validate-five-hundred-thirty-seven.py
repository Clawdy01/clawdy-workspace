...
repls = [
    ('three-hundred-sixty-one', 'five-hundred-thirty-seven'),
    ('driehonderdeenenzestig', 'vijfhonderdzevenendertig'),
    ('all_cases[:356]', 'all_cases[:522]'),
    ('{UNKNOWN, TYPO}][:356]', '{UNKNOWN, TYPO}][:522]'),
    ('!= 356', '!= 522'),
