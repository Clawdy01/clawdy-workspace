...
repls = [
    ('three-hundred-seventy-four', 'five-hundred-twenty-seven'),
    ('driehonderdvierenzeventig', 'vijfhonderdzevenentwintig'),
    ('all_cases[:369]', 'all_cases[:512]'),
    ('{UNKNOWN, TYPO}][:369]', '{UNKNOWN, TYPO}][:512]'),
    ('!= 369', '!= 512'),
