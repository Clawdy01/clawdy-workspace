...
repls = [
    ('four-hundred-forty-nine', 'four-hundred-fifty-one'),
    ('vierhonderdnegenenveertig', 'vierhonderdeenenvijftig'),
    ('all_cases[:434]', 'all_cases[:436]'),
    ('{UNKNOWN, TYPO}][:434]', '{UNKNOWN, TYPO}][:436]'),
    ('!= 434', '!= 436'),
    ('kreeg 434', 'kreeg 436'),
    (', 427, 428, 429, 430, 431, 432, 433]', ', 427, 428, 429, 430, 431, 432, 433, 434, 435]'),
]
for src_name in [
    ...
    src = root / src_name
    dst = root / src_name.replace('four-hundred-forty-nine', 'four-hundred-fifty-one')
    text = src.read_text()
