...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-four'),
    ('driehonderdvierentachtig', 'vierhonderdvier'),
    ('all_cases[:379]', 'all_cases[:399]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:399]'),
    ('!= 379', '!= 399'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-four')).write_text(text)
