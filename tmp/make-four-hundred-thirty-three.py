...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-thirty-three'),
    ('driehonderdvierentachtig', 'vierhonderddrieendertig'),
    ('all_cases[:379]', 'all_cases[:418]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:418]'),
    ('!= 379', '!= 418'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-thirty-three')).write_text(text)
