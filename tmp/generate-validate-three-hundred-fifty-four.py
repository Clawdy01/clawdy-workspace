...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-fifty-four'),
    ('tweehonderdnegenentwintig', 'driehonderdvierenvijftig'),
    ('[:227]', '[:350]'),
    ('!= 227', '!= 350'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-fifty-four-{kind}.py'
    text = src.read_text()
