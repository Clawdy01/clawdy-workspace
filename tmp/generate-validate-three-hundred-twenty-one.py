...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-twenty-one'),
    ('tweehonderdnegenentwintig', 'driehonderdeenentwintig'),
    ('[:227]', '[:317]'),
    ('!= 227', '!= 317'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-twenty-one-{kind}.py'
    text = src.read_text()
