...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-twenty-five'),
    ('driehonderdnegenenzestig', 'vijfhonderdvijfentwintig'),
    ('all_cases[:364]', 'all_cases[:510]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:510]'),
    ('!= 364', '!= 510'),
