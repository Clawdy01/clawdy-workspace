...
if len(valid_cases) != 401:
    raise SystemExit(f'kon geen vierhonderdacht geldige casenamen vinden, kreeg {valid_cases}')
...
if expected_stderr not in (plain_proc.stderr or ''):
    raise SystemExit('plain stderr noemt niet alle vierhonderdacht geldige first-seen cases')
