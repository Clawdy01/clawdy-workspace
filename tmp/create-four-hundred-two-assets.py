...
repls = [
    ('three-hundred-eighty-seven', 'four-hundred-two'),
    ('driehonderdzevenentachtig', 'vierhonderdtwee'),
    ('all_cases[:382]', 'all_cases[:397]'),
    ('{UNKNOWN, TYPO}][:382]', '{UNKNOWN, TYPO}][:397]'),
    ('!= 382', '!= 397'),
...
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'four-hundred-two')).write_text(text)
