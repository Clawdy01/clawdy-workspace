...
repls = [
    ('three-hundred-sixty-nine', 'four-hundred-thirteen'),
    ('driehonderdnegenenzestig', 'vierhonderddertien'),
...
for name in (
    ...
    src = root / 'tmp' / name
    dst = root / 'tmp' / name.replace('three-hundred-sixty-nine', 'four-hundred-thirteen')
    text = src.read_text()
