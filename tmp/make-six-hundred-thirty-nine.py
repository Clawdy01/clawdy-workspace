...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-thirty-nine'),
    ('driehonderdvierentachtig', 'zeshonderdnegenendertig'),
    ('all_cases[:379]', 'all_cases[:624]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:624]'),
    ('!= 379', '!= 624'),
