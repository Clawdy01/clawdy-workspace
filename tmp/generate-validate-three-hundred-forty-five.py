...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-forty-five'),
    ('tweehonderdnegenentwintig', 'driehonderdvijfenveertig'),
    ('[:227]', '[:341]'),
    ('!= 227', '!= 341'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-forty-five-{kind}.py'
    text = src.read_text()
