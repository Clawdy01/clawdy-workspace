...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-twenty-nine'),
    ('driehonderdvierentachtig', 'vierhonderdnegenentwintig'),
    ('all_cases[:379]', 'all_cases[:414]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:414]'),
    ('!= 379', '!= 414'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-twenty-nine')).write_text(text)
