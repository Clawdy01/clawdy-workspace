...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-eighty-four'),
    ('driehonderdvierentachtig', 'vijfhonderdvierentachtig'),
    ('all_cases[:379]', 'all_cases[:569]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:569]'),
    ('!= 379', '!= 569'),
