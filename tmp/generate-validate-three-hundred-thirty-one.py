...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-thirty-one'),
    ('tweehonderdnegenentwintig', 'driehonderdeenendertig'),
    ('[:227]', '[:327]'),
    ('!= 227', '!= 327'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-thirty-one-{kind}.py'
    text = src.read_text()
