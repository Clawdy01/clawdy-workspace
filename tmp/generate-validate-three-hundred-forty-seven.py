...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-forty-seven'),
    ('tweehonderdnegenentwintig', 'driehonderdzevenenveertig'),
    ('[:227]', '[:343]'),
    ('!= 227', '!= 343'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-forty-seven-{kind}.py'
    text = src.read_text()
