...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-twenty-two'),
    ('driehonderdnegenenzestig', 'vijfhonderdtweeëntwintig'),
    ('all_cases[:364]', 'all_cases[:507]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:507]'),
    ('!= 364', '!= 507'),
