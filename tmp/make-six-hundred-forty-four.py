...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-forty-four'),
    ('driehonderdvierentachtig', 'zeshonderdvierenveertig'),
    ('all_cases[:379]', 'all_cases[:629]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:629]'),
    ('!= 379', '!= 629'),
