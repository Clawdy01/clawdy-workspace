...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-seventy-two'),
    ('driehonderdvierentachtig', 'vierhonderdtweeënzeventig'),
    ('all_cases[:379]', 'all_cases[:457]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:457]'),
    ('!= 379', '!= 457'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-seventy-two')).write_text(text)
