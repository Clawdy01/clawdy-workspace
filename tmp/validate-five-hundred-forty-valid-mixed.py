...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:525]
if len(valid_cases) != 525:
    raise SystemExit(f'kon geen vijfhonderdveertig geldige casenamen vinden, kreeg {valid_cases}')
