...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-seventeen'),
    ('driehonderdvierentachtig', 'vierhonderdzeventien'),
    ('all_cases[:379]', 'all_cases[:402]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:402]'),
    ('!= 379', '!= 402'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-seventeen')).write_text(text)
