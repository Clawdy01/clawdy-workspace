...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:553]
if len(valid_cases) != 553:
    raise SystemExit(f'kon geen vijfhonderdachtenzestig geldige casenamen vinden, kreeg {valid_cases}')
