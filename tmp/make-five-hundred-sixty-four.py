...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-sixty-four'),
    ('driehonderdvierentachtig', 'vijfhonderdvierenzestig'),
    ('all_cases[:379]', 'all_cases[:549]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:549]'),
    ('!= 379', '!= 549'),
