...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:520]
if len(valid_cases) != 520:
    raise SystemExit(f'kon geen vijfhonderdvijfendertig geldige casenamen vinden, kreeg {valid_cases}')
