...
repls = [
    ('three-hundred-eighty-seven', 'four-hundred-five'),
    ('driehonderdzevenentachtig', 'vierhonderdvijf'),
    ('all_cases[:382]', 'all_cases[:400]'),
    ('{UNKNOWN, TYPO}][:382]', '{UNKNOWN, TYPO}][:400]'),
    ('!= 382', '!= 400'),
...
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'four-hundred-five')).write_text(text)
