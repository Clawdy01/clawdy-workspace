...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-twenty-four'),
    ('driehonderdnegenenzestig', 'vijfhonderdvierentwintig'),
    ('all_cases[:364]', 'all_cases[:509]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:509]'),
    ('!= 364', '!= 509'),
