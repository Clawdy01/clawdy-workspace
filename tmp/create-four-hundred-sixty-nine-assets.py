...
repls = [
    ('four-hundred-sixty-three', 'four-hundred-sixty-nine'),
    ('vierhonderddrieënzestig', 'vierhonderdnegenenzestig'),
    ('[:448]', '[:454]'),
    ('!= 448', '!= 454'),
    ('kreeg 448', 'kreeg 454'),
]
for name in files:
    ...
    (root / name.replace('four-hundred-sixty-three', 'four-hundred-sixty-nine')).write_text(text)
print('created')
