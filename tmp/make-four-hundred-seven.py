...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-seven'),
    ('driehonderdvierentachtig', 'vierhonderdzeven'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-seven')).write_text(text)
