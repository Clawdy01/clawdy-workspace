...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:518]
if len(valid_cases) != 518:
    raise SystemExit(f'kon geen vijfhonderddrieëndertig geldige casenamen vinden, kreeg {valid_cases}')
