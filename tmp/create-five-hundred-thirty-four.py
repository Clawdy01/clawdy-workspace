...
repls = [
    ('three-hundred-sixty-nine', 'five-hundred-thirty-four'),
    ('driehonderdnegenenzestig', 'vijfhonderdvierendertig'),
    ('all_cases[:364]', 'all_cases[:519]'),
    ('{UNKNOWN, TYPO}][:364]', '{UNKNOWN, TYPO}][:519]'),
    ('!= 364', '!= 519'),
