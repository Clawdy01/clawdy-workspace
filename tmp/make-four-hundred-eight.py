...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-eight'),
    ('driehonderdvierentachtig', 'vierhonderdacht'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-eight')).write_text(text)
