...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-sixty-nine'),
    ('driehonderdvierentachtig', 'vierhonderdnegenenzestig'),
    ('all_cases[:379]', 'all_cases[:454]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:454]'),
    ('!= 379', '!= 454'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-sixty-nine')).write_text(text)
