...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-fifty-four'),
    ('driehonderdvierentachtig', 'vierhonderdvierenvijftig'),
    ('all_cases[:379]', 'all_cases[:439]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:439]'),
    ('!= 379', '!= 439'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-fifty-four')).write_text(text)
