...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-eleven'),
    ('driehonderdvierentachtig', 'vierhonderdelf'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-eleven')).write_text(text)
