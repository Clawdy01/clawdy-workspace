...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-three'),
    ('driehonderdvierentachtig', 'vierhonderddrie'),
    ('all_cases[:379]', 'all_cases[:398]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:398]'),
    ('!= 379', '!= 398'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-three')).write_text(text)
