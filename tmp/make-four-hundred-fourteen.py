...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-fourteen'),
    ('driehonderdvierentachtig', 'vierhonderdveertien'),
    ('all_cases[:379]', 'all_cases[:401]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:401]'),
    ('!= 379', '!= 401'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-fourteen')).write_text(text)
