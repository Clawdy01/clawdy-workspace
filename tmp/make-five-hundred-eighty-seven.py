...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-eighty-seven'),
    ('driehonderdvierentachtig', 'vijfhonderdzevenentachtig'),
    ('all_cases[:379]', 'all_cases[:572]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:572]'),
    ('!= 379', '!= 572'),
