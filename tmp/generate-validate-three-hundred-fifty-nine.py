...
repls = [
    ('two-hundred-twenty-nine', 'three-hundred-fifty-nine'),
    ('tweehonderdnegenentwintig', 'driehonderdnegenenvijftig'),
    ('[:227]', '[:355]'),
    ('!= 227', '!= 355'),
...
for kind in ('valid-list-cases', 'valid-mixed'):
    ...
    dst = root / 'tmp' / f'validate-three-hundred-fifty-nine-{kind}.py'
    text = src.read_text()
