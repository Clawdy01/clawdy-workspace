...
repls = [
    ('four-hundred-fifty-eight', 'five-hundred-three'),
    ('vierhonderdachtenvijftig', 'vijfhonderddrie'),
    ('all_cases[:443]', 'all_cases[:488]'),
    ('{UNKNOWN, TYPO}][:443]', '{UNKNOWN, TYPO}][:488]'),
    ('!= 443', '!= 488'),
    ('kreeg 443', 'kreeg 488'),
    (', 430, 431, 432, 433, 434, 435, 436, 437, 438, 439, 440, 441, 442]', ', 430, 431, 432, 433, 434, 435, 436, 437, 438, 439, 440, 441, 442, 443, 444, 445, 446, 447, 448, 449, 450, 451, 452, 453, 454, 455, 456, 457, 458, 459, 460, 461, 462, 463, 464, 465, 466, 467, 468, 469, 470, 471, 472, 473, 474, 475, 476]'),
]
for src_name in [
