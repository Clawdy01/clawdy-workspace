...
repls = [
    ('three-hundred-eighty-four', 'four-hundred-sixty-five'),
    ('driehonderdvierentachtig', 'vierhonderdvijfenzestig'),
    ('all_cases[:379]', 'all_cases[:450]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:450]'),
    ('!= 379', '!= 450'),
...
for name in (
    ...
    (root / name.replace('three-hundred-eighty-four', 'four-hundred-sixty-five')).write_text(text)
