...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-forty-four'),
    ('driehonderdvierentachtig', 'vijfhonderdvierenveertig'),
    ('all_cases[:379]', 'all_cases[:529]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:529]'),
    ('!= 379', '!= 529'),
