...
repls = [
    ('three-hundred-eighty-seven', 'three-hundred-ninety'),
    ('driehonderdzevenentachtig', 'driehonderdnegentig'),
    ('all_cases[:382]', 'all_cases[:385]'),
    ('{UNKNOWN, TYPO}][:382]', '{UNKNOWN, TYPO}][:385]'),
    ('!= 382', '!= 385'),
    ('381]', '381, 382, 383, 384]'),
]
for name in files:
    ...
    (root / name.replace('three-hundred-eighty-seven', 'three-hundred-ninety')).write_text(text)
