...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:540]
if len(valid_cases) != 540:
    raise SystemExit(f'kon geen vijfhonderdvijfenvijftig geldige casenamen vinden, kreeg {valid_cases}')
