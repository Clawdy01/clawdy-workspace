...
repls = [
    ('three-hundred-eighty-four', 'five-hundred-fifty-eight'),
    ('driehonderdvierentachtig', 'vijfhonderdachtenvijftig'),
    ('all_cases[:379]', 'all_cases[:543]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:543]'),
    ('!= 379', '!= 543'),
