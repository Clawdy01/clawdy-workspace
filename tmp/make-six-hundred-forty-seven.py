...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-forty-seven'),
    ('driehonderdvierentachtig', 'zeshonderdzevenenveertig'),
    ('all_cases[:379]', 'all_cases[:632]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:632]'),
    ('!= 379', '!= 632'),
