...
repls = [
    ('three-hundred-eighty-four', 'six-hundred-fifty-two'),
    ('driehonderdvierentachtig', 'zeshonderdtweeënvijftig'),
    ('all_cases[:379]', 'all_cases[:637]'),
    ('{UNKNOWN, TYPO}][:379]', '{UNKNOWN, TYPO}][:637]'),
    ('!= 379', '!= 637'),
