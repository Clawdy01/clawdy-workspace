...
valid_cases = [case_name for case_name in all_cases if case_name not in {UNKNOWN, TYPO}][:492]
if len(valid_cases) != 492:
    raise SystemExit(f'kon geen vijfhonderdzeven geldige casenamen vinden, kreeg {valid_cases}')
