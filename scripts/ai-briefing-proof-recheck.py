...
def build_payload(status_data: dict, watchdog_data: dict) -> dict:
    ...
    return {
        ...
        'summary': summary,
        'status_text': first_non_null(status_data.get('status_text'), status_data.get('summary'), watchdog_data.get('status_text')),
        'reference_now_ms': first_non_null(status_data.get('reference_now_ms'), watchdog_data.get('reference_now_ms')),
        'reference_mode': first_non_null(status_data.get('reference_mode'), watchdog_data.get('reference_mode')),
        ...
        'readiness_phase': first_non_null(status_data.get('readiness_phase'), watchdog_data.get('readiness_phase')),
        'readiness_text': first_non_null(status_data.get('readiness_text'), watchdog_data.get('readiness_text')),
        ...
        'proof_target_runs': first_non_null(status_data.get('proof_target_runs'), watchdog_data.get('proof_target_runs')),
        'proof_qualified_runs': first_non_null(status_data.get('proof_qualified_runs'), watchdog_data.get('proof_qualified_runs')),
        'proof_target_met': proof_target_met,
        'proof_recheck_ready': recheck_window_open,
        'schedule': first_non_null(status_data.get('schedule'), watchdog_data.get('schedule')),
        'schedule_expr': first_non_null(status_data.get('schedule_expr'), watchdog_data.get('schedule_expr')),
        'schedule_tz': first_non_null(status_data.get('schedule_tz'), watchdog_data.get('schedule_tz')),
        'next_run_at': first_non_null(status_data.get('next_run_at'), watchdog_data.get('next_run_at')),
        ...
        'recent_run_duration_audit': first_non_null(status_data.get('recent_run_duration_audit'), watchdog_data.get('recent_run_duration_audit')),
        ...
        'proof_freshness': first_non_null(status_data.get('proof_freshness'), watchdog_data.get('proof_freshness')),
        'proof_freshness_text': first_non_null((status_data.get('proof_freshness') or {}).get('text'), watchdog_data.get('proof_freshness_text')),
        'proof_plan_text': first_non_null(status_data.get('proof_plan_text'), watchdog_data.get('proof_plan_text')),
        'summary_output_examples': summary_output_examples,
        'last_run_summary': first_non_null(status_data.get('last_run_summary'), watchdog_data.get('last_run_summary')),
        'last_run_output_audit_ok': first_non_null(status_data.get('last_run_output_audit_ok'), watchdog_data.get('last_run_output_audit_ok')),
        'last_run_output_audit_text': first_non_null(status_data.get('last_run_output_audit_text'), watchdog_data.get('last_run_output_audit_text')),
        'last_run_output_audit_item_count': first_non_null(status_data.get('last_run_output_audit_item_count'), watchdog_data.get('last_run_output_audit_item_count')),
        ...
        'last_run_output_audit_missing_source_examples': first_non_null(status_data.get('last_run_output_audit_missing_source_examples'), watchdog_data.get('last_run_output_audit_missing_source_examples')),
        'last_run_output_audit_missing_multi_source_examples': first_non_null(status_data.get('last_run_output_audit_missing_multi_source_examples'), watchdog_data.get('last_run_output_audit_missing_multi_source_examples')),
        ...
        'last_run_output_audit_missing_multi_domain_details': first_non_null(status_data.get('last_run_output_audit_missing_multi_domain_details'), watchdog_data.get('last_run_output_audit_missing_multi_domain_details')),
        'last_run_output_audit_missing_primary_source_examples': first_non_null(status_data.get('last_run_output_audit_missing_primary_source_examples'), watchdog_data.get('last_run_output_audit_missing_primary_source_examples')),
        ...
        'previous_run_slot_at': first_non_null(status_data.get('previous_run_slot_at'), watchdog_data.get('previous_run_slot_at')),
        'last_proof_qualified_run': first_non_null(status_data.get('last_proof_qualified_run'), watchdog_data.get('last_proof_qualified_run')),
        'last_proof_qualified_run_at': first_non_null(status_data.get('last_proof_qualified_run_at'), watchdog_data.get('last_proof_qualified_run_at')),
        'last_proof_qualified_run_at_text': first_non_null(status_data.get('last_proof_qualified_run_at_text'), watchdog_data.get('last_proof_qualified_run_at_text')),
        'last_proof_qualified_run_hint': first_non_null(status_data.get('last_proof_qualified_run_hint'), watchdog_data.get('last_proof_qualified_run_hint')),
        'last_proof_qualified_run_summary': first_non_null(status_data.get('last_proof_qualified_run_summary'), watchdog_data.get('last_proof_qualified_run_summary')),
        ...
        'proof_next_qualifying_slot_day_label': first_non_null(status_data.get('proof_next_qualifying_slot_day_label'), watchdog_data.get('proof_next_qualifying_slot_day_label')),
        'proof_no_more_qualifying_runs_today': first_non_null(status_data.get('proof_no_more_qualifying_runs_today'), watchdog_data.get('proof_no_more_qualifying_runs_today')),
        ...
        'proof_target_due_hint': first_non_null(status_data.get('proof_target_due_hint'), watchdog_data.get('proof_target_due_hint')),
        ...
        'proof_target_due_at_if_next_slot_missed_hint': first_non_null(status_data.get('proof_target_due_at_if_next_slot_missed_hint'), watchdog_data.get('proof_target_due_at_if_next_slot_missed_hint')),
