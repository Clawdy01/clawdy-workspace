...
def build_status(job_name=TARGET_JOB_NAME, reference_ms=None):
    ...
    summary = {
        ...
        'proof_recheck_schedule_expr': proof_recheck_schedule_audit.get('schedule_expr'),
        'proof_recheck_schedule_tz': proof_recheck_schedule_audit.get('schedule_tz'),
        'proof_recheck_schedule_expected_gap_minutes': proof_recheck_schedule_audit.get('expected_gap_minutes'),
        'proof_recheck_schedule_same_day_after_target': proof_recheck_schedule_audit.get('same_day_after_target'),
        'proof_recheck_schedule_matches_grace': proof_recheck_schedule_audit.get('matches_grace'),
        'proof_recheck_schedule_delta_minutes': proof_recheck_schedule_audit.get('delta_minutes'),
        'proof_recheck_schedule_text': proof_recheck_schedule_audit.get('text'),
    ...
    elif summary['proof_recheck_after_text']:
        proof_next_action_window_text = (
            f"hercheck vanaf {summary['proof_recheck_after_text']}"
            + (f" ({summary['proof_recheck_after_hint']})" if summary['proof_recheck_after_hint'] else '')
        )
    summary['proof_next_action_window_text'] = proof_next_action_window_text
...
def render_text(data):
    ...
    if (
        data.get('proof_recheck_window_text')
        and data.get('proof_recheck_window_text') != data.get('proof_next_action_window_text')
        and data.get('proof_recheck_window_text') != data.get('proof_next_action_text')
    ):
