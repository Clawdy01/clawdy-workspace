...
COMMANDS = {
    ...
    'mail-now-empty': {
        'cmd': ['python3', str(ROOT / 'scripts' / 'mail-dispatch.py'), 'now-empty'],
    ...
    'mail-open': {
        'cmd': ['python3', str(ROOT / 'scripts' / 'mail-dispatch.py'), 'open'],
    ...
    'mail-open-now': {
        'cmd': ['python3', str(ROOT / 'scripts' / 'mail-dispatch.py'), 'open-now'],
        'description': 'Open direct alleen de aanbevolen actuele mailthread zonder losse --current-only vlag',
    },
    'mail-open-review': {
        'cmd': ['python3', str(ROOT / 'scripts' / 'mail-dispatch.py'), 'open-review'],
...
ALIASES = {
    ...
    '/mail-review-next': 'mail-open',
    '/mail-review': 'mail-open',
    '/mail-open': 'mail-open',
    '/mail-next-thread': 'mail-open',
    '/mail-review-next-now': 'mail-open-now',
    '/mail-now-open': 'mail-open-now',
    '/mail-open-now': 'mail-open-now',
    '/mail-review-next-current': 'mail-open-now',
    '/mail-open-current': 'mail-open-now',
    '/mail-review-next-review': 'mail-open-review',
    '/mail-review-open': 'mail-open-review',
    '/mail-open-review': 'mail-open-review',
    '/mail-review-next-review-worthy': 'mail-open-review',
    '/mail-open-review-worthy': 'mail-open-review',
