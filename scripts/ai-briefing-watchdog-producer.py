...
def build_quiet_summary(stdout: str, stderr: str, returncode: int) -> str | None:
    ...
    if payload.get('proof_next_action_window_text'):
        ...
        if (
            ...
            and proof_recheck_after_text_compact != payload.get('proof_next_action_window_text')
            and proof_recheck_after_text_compact != payload.get('proof_recheck_window_text')
            and proof_recheck_after_text_compact != payload.get('proof_next_action_text')
        ):
        ...
        if payload.get('proof_recheck_window_text') and payload.get('proof_recheck_window_text') != payload.get('proof_next_action_text'):
            ...
            if (
                proof_recheck_after_text_compact
                and proof_recheck_after_text_compact != payload.get('proof_next_action_text')
                and proof_recheck_after_text_compact != payload.get('proof_wait_until_text')
                and proof_recheck_after_text_compact != payload.get('proof_wait_until_reason_text')
            ):
                bits.append(str(proof_recheck_after_text_compact))
...
def build_overall_summary(payload: dict, returncode: int) -> dict:
    ...
    overall = {
        ...
        'reference_now_ms': payload.get('reference_now_ms'),
        ...
        'proof_runs_remaining': payload.get('proof_runs_remaining'),
        'proof_requirement_met': payload.get('proof_requirement_met'),
        ...
        'schedule_tz': payload.get('schedule_tz'),
        ...
        'next_run_at_text': payload.get('next_run_at_text'),
        'previous_run_slot_at': payload.get('previous_run_slot_at'),
        'previous_run_slot_at_text': payload.get('previous_run_slot_at_text'),
        'last_proof_qualified_run': payload.get('last_proof_qualified_run'),
        'last_proof_qualified_run_at': payload.get('last_proof_qualified_run_at'),
        'last_proof_qualified_run_at_text': payload.get('last_proof_qualified_run_at_text'),
        'last_proof_qualified_run_hint': payload.get('last_proof_qualified_run_hint'),
        'last_proof_qualified_run_summary': payload.get('last_proof_qualified_run_summary'),
        ...
        'proof_due_at': payload.get('proof_due_at'),
        'proof_due_at_text': payload.get('proof_due_at_text'),
        'proof_due_hint': payload.get('proof_due_hint'),
        ...
        'proof_target_runs': payload.get('proof_target_runs'),
        'proof_qualified_runs': payload.get('proof_qualified_runs'),
        'proof_target_run_slots': payload.get('proof_target_run_slots'),
        'proof_target_run_slot_texts': payload.get('proof_target_run_slot_texts'),
        'proof_target_run_slot_hints': payload.get('proof_target_run_slot_hints'),
        'proof_target_run_slot_context_texts': payload.get('proof_target_run_slot_context_texts'),
        'proof_target_run_slot_day_labels': payload.get('proof_target_run_slot_day_labels'),
        ...
        'proof_next_qualifying_slot_day_label': payload.get('proof_next_qualifying_slot_day_label'),
        'proof_no_more_qualifying_runs_today': payload.get('proof_no_more_qualifying_runs_today'),
        'has_run_proof': payload.get('has_run_proof'),
        'attention_needed': payload.get('attention_needed'),
        'expected_proof_freshness_wait': payload.get('expected_proof_freshness_wait'),
        'job_name': payload.get('job_name'),
        'required_qualified_runs': payload.get('required_qualified_runs'),
        'proof_freshness': payload.get('proof_freshness'),
        ...
        'last_run_at_text': payload.get('last_run_at_text'),
        'last_run_hint': payload.get('last_run_hint'),
        'last_run_status': payload.get('last_run_status'),
        'last_run_timeout_text': payload.get('last_run_timeout_text'),
        'last_run_timeout_audit': payload.get('last_run_timeout_audit'),
        'last_run_timeout_near_timeout': payload.get('last_run_timeout_near_timeout'),
        'last_run_timeout_timed_out': payload.get('last_run_timeout_timed_out'),
        'recent_run_duration_audit': payload.get('recent_run_duration_audit') or {},
        'recent_run_duration_text': payload.get('recent_run_duration_text'),
        'recent_run_duration_near_timeout': payload.get('recent_run_duration_near_timeout'),
        'recent_run_duration_timed_out': payload.get('recent_run_duration_timed_out'),
        'last_run_summary': payload.get('last_run_summary'),
        'last_run_output_audit_ok': payload.get('last_run_output_audit_ok'),
        'last_run_output_audit_text': payload.get('last_run_output_audit_text'),
        'last_run_output_audit_item_count': payload.get('last_run_output_audit_item_count'),
        'last_run_output_audit_multi_domain_top3_count': payload.get('last_run_output_audit_multi_domain_top3_count'),
        'last_run_output_audit_fresh_top3_count': payload.get('last_run_output_audit_fresh_top3_count'),
        'last_run_output_audit_primary_fresh_top3_count': payload.get('last_run_output_audit_primary_fresh_top3_count'),
        'last_run_output_audit_missing_source_examples': payload.get('last_run_output_audit_missing_source_examples') or [],
        'last_run_output_audit_missing_multi_source_examples': payload.get('last_run_output_audit_missing_multi_source_examples') or [],
        'last_run_output_audit_missing_multi_domain_examples': payload.get('last_run_output_audit_missing_multi_domain_examples') or [],
        'last_run_output_audit_missing_multi_domain_details': payload.get('last_run_output_audit_missing_multi_domain_details') or [],
        'last_run_output_audit_missing_primary_source_examples': payload.get('last_run_output_audit_missing_primary_source_examples') or [],
        'last_run_output_audit_missing_recent_date_examples': payload.get('last_run_output_audit_missing_recent_date_examples') or [],
        'last_run_output_audit_missing_fresh_examples': payload.get('last_run_output_audit_missing_fresh_examples') or [],
        'last_run_output_audit_missing_primary_fresh_examples': payload.get('last_run_output_audit_missing_primary_fresh_examples') or [],
        'last_run_output_audit_missing_fresh_details': payload.get('last_run_output_audit_missing_fresh_details') or [],
        'last_run_output_audit_missing_primary_fresh_details': payload.get('last_run_output_audit_missing_primary_fresh_details') or [],
