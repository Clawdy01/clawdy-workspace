...
def build_alert(data: dict, mode: str, require_qualified_runs: int) -> str:
    ...
    proof_target_due_text = data.get('proof_target_due_at_text')
    ...
    if (
        require_qualified_runs > 0
        and data.get('proof_recheck_after_text_compact')
    ...
    if proof_target_due_text and require_qualified_runs > 0 and proof_target_due_text not in richer_due_context:
        bits.append(f"bewijsdoel {proof_target_due_text}")
    if (
...
def build_json_payload(
    ...
    *,
    ...
    return {
        ...
        'status_text': data.get('status_text') or data.get('summary'),
        'alert_text': alert_text,
        'readiness_phase': data.get('readiness_phase'),
        'readiness_text': data.get('readiness_text'),
        'reference_now_ms': data.get('reference_now_ms'),
        'reference_now_text': data.get('reference_now_text'),
        ...
        'proof_runs_remaining': data.get('proof_runs_remaining'),
        'proof_requirement_met': data.get('proof_requirement_met'),
        'proof_target_met': data.get('proof_target_met'),
        'expected_proof_freshness_wait': data.get('expected_proof_freshness_wait'),
        ...
        'schedule_tz': data.get('schedule_tz'),
        ...
        'proof_wait_until_hint': data.get('proof_wait_until_hint'),
        'proof_wait_until_remaining_ms': data.get('proof_wait_until_remaining_ms'),
        'proof_wait_until_remaining_hours': data.get('proof_wait_until_remaining_hours'),
        ...
        'proof_next_qualifying_slot_hint': data.get('proof_next_qualifying_slot_hint'),
        'proof_next_qualifying_slot_remaining_ms': data.get('proof_next_qualifying_slot_remaining_ms'),
        'proof_next_qualifying_slot_remaining_hours': data.get('proof_next_qualifying_slot_remaining_hours'),
        'proof_next_qualifying_slot_day_label': data.get('proof_next_qualifying_slot_day_label'),
        'proof_no_more_qualifying_runs_today': data.get('proof_no_more_qualifying_runs_today'),
        'proof_today_block_text': data.get('proof_today_block_text'),
        'proof_recheck_grace_ms': data.get('proof_recheck_grace_ms'),
        ...
        'proof_recheck_after_hint': data.get('proof_recheck_after_hint'),
        'proof_recheck_after_remaining_ms': data.get('proof_recheck_after_remaining_ms'),
        'proof_recheck_after_remaining_hours': data.get('proof_recheck_after_remaining_hours'),
        'proof_target_due_at': data.get('proof_target_due_at'),
        'proof_target_due_at_text': data.get('proof_target_due_at_text'),
        'proof_target_due_hint': data.get('proof_target_due_hint'),
        ...
        'proof_target_due_at_if_next_slot_missed_hint': data.get('proof_target_due_at_if_next_slot_missed_hint'),
        'proof_schedule_slip_ms': data.get('proof_schedule_slip_ms'),
        'proof_schedule_slip_hours': data.get('proof_schedule_slip_hours'),
        ...
        'proof_due_at': data.get('proof_due_at'),
        'proof_due_at_text': data.get('proof_due_at_text'),
        'proof_due_hint': data.get('proof_due_hint'),
        'proof_target_runs': data.get('proof_target_runs'),
        'proof_qualified_runs': data.get('proof_qualified_runs'),
        'proof_target_run_slots': data.get('proof_target_run_slots'),
        'proof_target_run_slot_texts': data.get('proof_target_run_slot_texts'),
        'proof_target_run_slot_hints': data.get('proof_target_run_slot_hints'),
        'proof_target_run_slot_context_texts': data.get('proof_target_run_slot_context_texts'),
        'proof_target_run_slot_day_labels': data.get('proof_target_run_slot_day_labels'),
        ...
        'proof_target_due_remaining_ms': data.get('proof_target_due_remaining_ms'),
        'proof_target_due_remaining_hours': data.get('proof_target_due_remaining_hours'),
        'proof_target_due_at_if_next_slot_missed_remaining_ms': data.get('proof_target_due_at_if_next_slot_missed_remaining_ms'),
        'proof_target_due_at_if_next_slot_missed_remaining_hours': data.get('proof_target_due_at_if_next_slot_missed_remaining_hours'),
        'proof_freshness': data.get('proof_freshness'),
        'proof_freshness_text': data.get('proof_freshness_text'),
        'proof_plan_text': data.get('proof_plan_text'),
        'next_run_at_text': data.get('next_run_at_text'),
        'previous_run_slot_at': data.get('previous_run_slot_at'),
        'previous_run_slot_at_text': data.get('previous_run_slot_at_text'),
        'last_proof_qualified_run': data.get('last_proof_qualified_run'),
        'last_proof_qualified_run_at': data.get('last_proof_qualified_run_at'),
        'last_proof_qualified_run_at_text': data.get('last_proof_qualified_run_at_text'),
        'last_proof_qualified_run_hint': data.get('last_proof_qualified_run_hint'),
        'last_proof_qualified_run_summary': data.get('last_proof_qualified_run_summary'),
        'has_run_proof': data.get('has_run_proof'),
        'attention_needed': data.get('attention_needed'),
        'last_run_at': data.get('last_run_at'),
        'last_run_at_text': data.get('last_run_at_text'),
        'last_run_hint': data.get('last_run_hint'),
        'last_run_status': data.get('last_run_status'),
        'last_run_timeout_audit': data.get('last_run_timeout_audit'),
        'last_run_summary': data.get('last_run_summary'),
        'last_run_output_audit_ok': data.get('last_run_output_audit_ok'),
        'last_run_output_audit_text': data.get('last_run_output_audit_text'),
        'last_run_output_audit_item_count': data.get('last_run_output_audit_item_count'),
        'last_run_output_audit_multi_domain_top3_count': data.get('last_run_output_audit_multi_domain_top3_count'),
        'last_run_output_audit_fresh_top3_count': data.get('last_run_output_audit_fresh_top3_count'),
        'last_run_output_audit_primary_fresh_top3_count': data.get('last_run_output_audit_primary_fresh_top3_count'),
        'last_run_output_audit_missing_source_examples': data.get('last_run_output_audit_missing_source_examples') or [],
        'last_run_output_audit_missing_multi_source_examples': data.get('last_run_output_audit_missing_multi_source_examples') or [],
        'last_run_output_audit_missing_multi_domain_examples': data.get('last_run_output_audit_missing_multi_domain_examples') or [],
        'last_run_output_audit_missing_multi_domain_details': data.get('last_run_output_audit_missing_multi_domain_details') or [],
        'last_run_output_audit_missing_primary_source_examples': data.get('last_run_output_audit_missing_primary_source_examples') or [],
        'last_run_output_audit_missing_recent_date_examples': data.get('last_run_output_audit_missing_recent_date_examples') or [],
        'last_run_output_audit_missing_fresh_examples': data.get('last_run_output_audit_missing_fresh_examples') or [],
        'last_run_output_audit_missing_fresh_details': data.get('last_run_output_audit_missing_fresh_details') or [],
        'last_run_output_audit_missing_primary_fresh_examples': data.get('last_run_output_audit_missing_primary_fresh_examples') or [],
        'last_run_output_audit_missing_primary_fresh_details': data.get('last_run_output_audit_missing_primary_fresh_details') or [],
        'last_run_timeout_text': data.get('last_run_timeout_text'),
        'last_run_timeout_near_timeout': data.get('last_run_timeout_near_timeout'),
        'last_run_timeout_timed_out': data.get('last_run_timeout_timed_out'),
        ...
        'recent_run_duration_near_timeout': data.get('recent_run_duration_near_timeout'),
        ...
        'consumer_outputs_text': data.get('consumer_outputs_text') or format_consumer_outputs(data.get('consumer_outputs') or []),
        ...
        'consumer_outputs_missing_text': data.get('consumer_outputs_missing_text') or format_consumer_outputs(data.get('consumer_outputs_missing') or []),
        ...
        'consumer_outputs_unexpected_text': data.get('consumer_outputs_unexpected_text') or format_consumer_outputs(data.get('consumer_outputs_unexpected') or []),
        ...
        'consumer_effective_outputs_text': data.get('consumer_effective_outputs_text') or format_consumer_outputs(data.get('consumer_effective_outputs') or []),
        ...
        'consumer_effective_outputs_missing_text': data.get('consumer_effective_outputs_missing_text') or format_consumer_outputs(data.get('consumer_effective_outputs_missing') or []),
        ...
        'consumer_effective_outputs_unexpected_text': data.get('consumer_effective_outputs_unexpected_text') or format_consumer_outputs(data.get('consumer_effective_outputs_unexpected') or []),
