...
def emit_output_with_bundle(*, text: str, payload: dict, stdout_format: str, stdout_output_path: str | None = None, stdout_output_format: str | None = None, stdout_append: bool = False, consumer_bundle: str | None = None, consumer_presets: dict[str, dict] | None = None) -> None:
    ...
    if stdout_output_path:
        rendered = render_output(
            text=text,
            payload=payload,
            output_format=stdout_output_format or stdout_format,
        )
...
def main() -> int:
    ...
    result = {
        ...
        'schedule_expr': status.get('schedule_expr'),
        'schedule_tz': status.get('schedule_tz'),
        'next_run_at': status.get('next_run_at'),
        'next_run_at_text': status.get('next_run_at_text'),
        'proof_due_at': status.get('proof_due_at'),
        'proof_due_at_text': status.get('proof_due_at_text'),
        'proof_due_hint': status.get('proof_due_hint'),
        'proof_text': status.get('proof_text'),
        'last_run_at': status.get('last_run_at'),
        'last_run_at_text': status.get('last_run_at_text'),
        'last_run_hint': status.get('last_run_hint'),
        'last_run_status': status.get('last_run_status'),
        'proof_target_due_at_text': status.get('proof_target_due_at_text'),
        'proof_target_due_hint': status.get('proof_target_due_hint'),
        ...
        'proof_target_due_at_if_next_slot_missed': status.get('proof_target_due_at_if_next_slot_missed'),
        'proof_target_due_at_if_next_slot_missed_text': status.get('proof_target_due_at_if_next_slot_missed_text'),
        'proof_target_due_at_if_next_slot_missed_hint': status.get('proof_target_due_at_if_next_slot_missed_hint'),
        ...
        'proof_target_run_slots': status.get('proof_target_run_slots'),
        'proof_target_run_slot_texts': status.get('proof_target_run_slot_texts'),
        'proof_target_run_slot_hints': status.get('proof_target_run_slot_hints'),
        'proof_target_run_slot_context_texts': status.get('proof_target_run_slot_context_texts'),
        ...
        'last_proof_qualified_run': status.get('last_proof_qualified_run'),
        'last_proof_qualified_run_at': status.get('last_proof_qualified_run_at'),
        'last_proof_qualified_run_at_text': status.get('last_proof_qualified_run_at_text'),
        'last_proof_qualified_run_hint': status.get('last_proof_qualified_run_hint'),
        'last_proof_qualified_run_summary': status.get('last_proof_qualified_run_summary'),
        'has_run_proof': status.get('has_run_proof'),
        'attention_needed': status.get('attention_needed'),
        'status_text': status.get('text'),
        'proof_freshness': status.get('proof_freshness'),
        'proof_freshness_text': ((status.get('proof_freshness') or {}).get('text') or '').strip() or None,
        'last_run_summary': status.get('last_run_summary'),
        'last_run_output_audit_ok': status.get('last_run_output_audit_ok'),
        'last_run_output_audit_text': status.get('last_run_output_audit_text'),
        'last_run_output_audit_item_count': status.get('last_run_output_audit_item_count'),
        'last_run_output_audit_multi_domain_top3_count': status.get('last_run_output_audit_multi_domain_top3_count'),
        'last_run_output_audit_fresh_top3_count': status.get('last_run_output_audit_fresh_top3_count'),
        'last_run_output_audit_primary_fresh_top3_count': status.get('last_run_output_audit_primary_fresh_top3_count'),
        'last_run_output_audit_missing_source_examples': status.get('last_run_output_audit_missing_source_examples'),
        'last_run_output_audit_missing_multi_source_examples': status.get('last_run_output_audit_missing_multi_source_examples'),
        'last_run_output_audit_missing_multi_domain_examples': status.get('last_run_output_audit_missing_multi_domain_examples'),
        'last_run_output_audit_missing_multi_domain_details': status.get('last_run_output_audit_missing_multi_domain_details'),
        'last_run_output_audit_missing_primary_source_examples': status.get('last_run_output_audit_missing_primary_source_examples'),
        'last_run_output_audit_missing_recent_date_examples': status.get('last_run_output_audit_missing_recent_date_examples'),
        'last_run_output_audit_missing_fresh_examples': status.get('last_run_output_audit_missing_fresh_examples'),
        'last_run_output_audit_missing_primary_fresh_examples': status.get('last_run_output_audit_missing_primary_fresh_examples'),
        'last_run_output_audit_missing_fresh_details': status.get('last_run_output_audit_missing_fresh_details'),
        'last_run_output_audit_missing_primary_fresh_details': status.get('last_run_output_audit_missing_primary_fresh_details'),
    ...
    result.update({
        ...
        'consumer_requested_output_paths': [item['path'] for item in consumer_requested_outputs],
        'consumer_requested_output_channels': [item['channel'] for item in consumer_requested_outputs],
        'consumer_requested_outputs_text': format_consumer_outputs(consumer_requested_outputs),
        'consumer_outputs': consumer_requested_outputs,
        'consumer_output_paths': [item['path'] for item in consumer_requested_outputs],
        'consumer_output_channels': [item['channel'] for item in consumer_requested_outputs],
        'consumer_outputs_text': format_consumer_outputs(consumer_requested_outputs),
    })
    update_consumer_output_audit(result)
    result.update(
        build_run_metadata(
