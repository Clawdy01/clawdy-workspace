...
- `scripts/media-sanity-check.py` — snelle inspectie van video/audio/image-output, inclusief JSON, preset/fail-profielen, threshold-warnings, directory/batch-check via `--dir` en CI-vriendelijke fail-modes voor zowel per-bestand als mixed batch-runs
