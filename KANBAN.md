...
## Blocked
- `daily-ai-update` heeft nu nog een echte tijdsgebonden blocker: de run van `2026-04-17 09:00 CEST` liep in timeout (`cron: job execution timed out`) op de oude limiet van 300s (`lastDurationMs: 300815`), de timeout is inmiddels verhoogd naar 480s, maar er kan vandaag geen kwalificerende proof-run meer bijkomen en de eerstvolgende kans ligt pas op `2026-04-18 09:00 CEST`
